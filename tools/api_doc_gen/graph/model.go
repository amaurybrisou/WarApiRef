...
type Frame struct {
	...
	// StructuralChildAttrValues samples up to 8 unique observed attribute values per
	// structural child type and attribute key.
	// e.g. {"ListData": {"populationfunction": ["AggroMeterGrayList.Populate", "MoraleFiller.Populate"]}}
