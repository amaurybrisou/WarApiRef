...
| Example locations | ClosetGoblinSetRowBackgroundName, ClosetGoblinZoneRowBackgroundZone |
| XML usage count | 2 |
...
- [FullResizeImage](../../xml/element_types/element_FullResizeImage.md) (HIGH 90/100) - XML Element Type
