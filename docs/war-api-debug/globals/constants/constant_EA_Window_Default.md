...
| Files seen in | ClosetGoblin.xml, ClosetGoblinItemRack.xml |
| Namespaces detected | EA_Window_Default |
| Source kinds | xml_attributes |
| Example locations | CG_ItemRackEQShow1, ClosetGoblinCharacterWindow, ClosetGoblinOptionWindow, ClosetGoblinZoneWindow |
| XML usage count | 4 |
