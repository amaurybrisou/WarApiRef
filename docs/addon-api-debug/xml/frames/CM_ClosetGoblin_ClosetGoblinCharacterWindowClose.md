# Frame ClosetGoblinCharacterWindowClose

- Addon: CM_ClosetGoblin
- Resolved Name: ClosetGoblinCharacterWindowClose
...
<Button inherits="EA_Button_DefaultWindowClose" name="...">
  ...
  <EventHandlers>
    <EventHandler event="OnLButtonUp" function="ClosetGoblinCharacterWindow.Hide"/>
  </EventHandlers>
</Button>
```
...
| Event | Function |
| --- | --- |
| OnLButtonUp | ClosetGoblinCharacterWindow.Hide |
