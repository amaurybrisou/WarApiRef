# Frame ClosetGoblinCharacterWindowContentsZoneConfig

- Addon: CM_ClosetGoblin
- Resolved Name: ClosetGoblinCharacterWindowContentsZoneConfig
- Raw Name: $parentZoneConfig
- Type: Button
...
<Button font="font_chat_text" inherits="EA_Button_DefaultResizeable" name="..." textalign="center">
  <Anchors>
    <Anchor point="bottomleft" relativePoint="topleft" relativeTo="$parentNewSet">
      <AbsPoint x="0" y="15"/>
    </Anchor>
  </Anchors>
  <EventHandlers>
...
| Event | Function |
| --- | --- |
| OnLButtonUp | ClosetGoblinCharacterWindow.OnClickZoneConfigButton |
