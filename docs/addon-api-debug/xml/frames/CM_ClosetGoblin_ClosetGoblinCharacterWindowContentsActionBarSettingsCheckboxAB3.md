# Frame ClosetGoblinCharacterWindowContentsActionBarSettingsCheckboxAB3

- Addon: CM_ClosetGoblin
- Resolved Name: ClosetGoblinCharacterWindowContentsActionBarSettingsCheckboxAB3
- Raw Name: $parentCheckboxAB3
- Type: Button
...
<Button inherits="EA_Button_DefaultCheckBox" layer="overlay" name="...">
  <Anchors>
    <Anchor point="bottom" relativePoint="top" relativeTo="$parentLabelAB3">
      <AbsPoint x="0" y="0"/>
    </Anchor>
  </Anchors>
  <EventHandlers>
...
- inherits: EA_Button_DefaultCheckBox
- layer: overlay
- name: $parentCheckboxAB3

## Handlers

| Event | Function |
| --- | --- |
| OnLButtonUp | ClosetGoblinCharacterWindow.HotbarChangeToggled3 |
