# Frame ClosetGoblinZoneWindowContentsSortDownArrow

- Addon: CM_ClosetGoblin
- Resolved Name: ClosetGoblinZoneWindowContentsSortDownArrow
- Raw Name: $parentSortDownArrow
- Type: DynamicImage
- Parent: ClosetGoblinZoneWindowContents
- Parent Type: Window
- Inherits: EA_ListSortDownArrow
- Template: no
...
```xml
<DynamicImage inherits="EA_ListSortDownArrow" name="...">
  <Anchors>
