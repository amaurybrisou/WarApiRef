# Frame ClosetGoblinZoneWindowBackground

- Addon: CM_ClosetGoblin
- Resolved Name: ClosetGoblinZoneWindowBackground
- Raw Name: $parentBackground
- Type: Window
...
```xml
<Window inherits="EA_Window_DefaultFrame" name="...">
  <Anchors>
