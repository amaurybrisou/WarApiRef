...
| Evidence | Value |
| --- | --- |
| Addons seen in | MapPin, Queue Queuer, QuickWarReport, followTheLeader |
| Files seen in | `/workspace/MapPin/source/MapPin.lua:1122`, `/workspace/MapPin/source/MapPin.lua:2280`, `/workspace/MapPin/source/MapPin.lua:3008`, `/workspace/MapPin/source/MapPin.lua:3011`, `/workspace/MapPin/source/MapPin.lua:4452`, `/workspace/QueueQueuer/QueueQueuer.lua:1592`, `/workspace/QuickWarReport/QWRComms.lua:28`, `/workspace/followTheLeader/followTheLeader.lua:209` |
