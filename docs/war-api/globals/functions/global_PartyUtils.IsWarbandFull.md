...
| Evidence | Value |
| --- | --- |
| Addons seen in | SocialWindow 2.0, rorAutoInviter |
| Files seen in | rorAutoInviter.lua, source/socialwindow.lua |
| Namespaces detected | PartyUtils |
| Source kinds | lua_calls |
| Example locations | SocialWindow 2.0: ShowPlayerContextMenuWindow, rorAutoInviter: OnMessageReceived |
| XML usage count | 0 |
...
- SocialWindow 2.0: ShowPlayerContextMenuWindow -> PartyUtils.IsWarbandFull()
- rorAutoInviter: OnMessageReceived -> PartyUtils.IsWarbandFull()
