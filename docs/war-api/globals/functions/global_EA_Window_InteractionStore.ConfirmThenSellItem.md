...
```lua
EA_Window_InteractionStore.ConfirmThenSellItem(arg1, arg2)
```
...
- BankWindowFix: BagEquipmentRButtonUp -> EA_Window_InteractionStore.ConfirmThenSellItem(slot, itemData.stackCount)
