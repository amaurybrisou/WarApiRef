...
| Evidence | Value |
| --- | --- |
| Addons seen in | Refer |
| Files seen in | Refer.lua |
| Namespaces detected | PartyUtils |
| Source kinds | lua_calls |
| Example locations | Refer: ModifiedAddGroupMenuItems |
| XML usage count | 0 |
...
```lua
PartyUtils.GetBolsterMenuText(arg1)
```
...
| Name | Role | Evidence |
| --- | --- | --- |
| arg1 | Observed as a runtime window or control identifier. | Observed values: playerName |
...
- Refer: ModifiedAddGroupMenuItems -> PartyUtils.GetBolsterMenuText(playerName)
