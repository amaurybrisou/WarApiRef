...
```lua
EA_Window_Backpack.GetPocketNumberForSlot(arg1, arg2)
```
...
| arg2 | Observed as a runtime window or control identifier. | Observed values: slot |
...
- JunkDump: JunkDump.SetTestModeTint -> EA_Window_Backpack.GetPocketNumberForSlot(backpackType, slot)
