...
| Namespaces detected | EA_Window_OpenPartyFlyOut |
| Source kinds | xml_attributes |
| Example locations | EA_Window_OpenPartyFlyOutBackground, EA_Window_OpenPartyFlyOutHeader, EA_Window_OpenPartyFlyOutLeader1RatioText, EA_Window_OpenPartyFlyOutLeader1Text, EA_Window_OpenPartyFlyOutLeader2RatioText, EA_Window_OpenPartyFlyOutLeader2Text |
| XML usage count | 8 |
