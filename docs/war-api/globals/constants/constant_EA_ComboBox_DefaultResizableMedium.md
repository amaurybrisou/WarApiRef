...
| Evidence | Value |
| --- | --- |
| Addons seen in | BankArkel, DeepSleep |
| Files seen in | `/workspace/BankArkel/BankArkel.xml:313`, `/workspace/DeepSleep/Settings.xml:126` |
| Namespaces detected | EA_ComboBox_DefaultResizableMedium |
| Source kinds | xml_attributes |
| Example locations | BankArkelBackpackCombo, DeepSleep_Templates_CheckBoxComboBox |
| XML usage count | 2 |
