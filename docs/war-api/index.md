...
Generated from addon-api rooted at `/workspace/WAR_API_Ref/docs/addon-api`. The source corpus contained 9884 function docs, 5438 frame docs, 2533 handler docs, and 237 event docs.
