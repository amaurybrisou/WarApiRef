...
| Files seen in | `/workspace/data/raw/Enemy/Code/Core/Communication.lua:46` |
| Namespaces detected | GameData |
| Source kinds | lua_call |
| Example locations | Enemy.OnChatTextArrived, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: Enemy.OnChatTextArrived, lua_call
