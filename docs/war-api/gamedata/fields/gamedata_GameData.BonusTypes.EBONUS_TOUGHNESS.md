...
| Files seen in | `/workspace_addons/Effigy/States/EffigyStatePlayer.lua:193` |
| Namespaces detected | GameData |
| Source kinds | lua_call |
| Example locations | Effigy.UpdatePlayerToughness, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: Effigy.UpdatePlayerToughness, lua_call
