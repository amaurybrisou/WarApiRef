...
| Files seen in | `/workspace_addons/Effigy/States/EffigyStatePets.lua:55` |
| Namespaces detected | GameData |
| Source kinds | lua_call |
| Example locations | Effigy.UpdatePlayerPetTarget, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: Effigy.UpdatePlayerPetTarget, lua_call
