...
| Files seen in | `/workspace_addons/Effigy/States/EffigyStatePlayer.lua:216` |
| Namespaces detected | GameData |
| Source kinds | lua_call |
| Example locations | Effigy.UpdatePlayerArmor, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: Effigy.UpdatePlayerArmor, lua_call
