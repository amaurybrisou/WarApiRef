...
| Files seen in | `/workspace_addons/Effigy/States/EffigyStateCastbar.lua:117` |
| Namespaces detected | GameData |
| Source kinds | lua_call |
| Example locations | Effigy.StartInteract, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: Effigy.StartInteract, lua_call
