...
- Effigy: Effigy.RegisterStateInfoForTargets -> LibUnits.Events.PLAYER_HOSTILE_TARGET_UPDATED -> selfhostiletarget
- Effigy: selfhostiletarget -> RegisterEventHandler(LibUnits.Events.PLAYER_HOSTILE_TARGET_UPDATED, selfhostiletarget)

## Related APIs

- [selfhostiletarget](game_event_selfhostiletarget.md) (MEDIUM 43/100) - Game Event
