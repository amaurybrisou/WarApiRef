...
- Effigy.Name..".OnPlayerPetTargetHealthUpdated"
- RegisterEventHandler
- global

## Examples

- Effigy: Effigy.RegisterStateInfoForPets -> SystemData.Events.PLAYER_PET_TARGET_HEALTH_UPDATED -> Effigy.Name..".OnPlayerPetTargetHealthUpdated"
- Effigy: Effigy.Name..".OnPlayerPetTargetHealthUpdated" -> RegisterEventHandler(SystemData.Events.PLAYER_PET_TARGET_HEALTH_UPDATED, Effigy.Name..".OnPlayerPetTargetHealthUpdated")
