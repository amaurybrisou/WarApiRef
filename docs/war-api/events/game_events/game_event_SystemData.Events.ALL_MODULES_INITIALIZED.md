...
| Evidence | Value |
| --- | --- |
| Addons seen in | CM_ClosetGoblin, RoR_SoR |
...
| Example locations | CM_ClosetGoblin: ClosetGoblin.OnInitialize, RoR_SoR: RoR_SoR:RegisterSelfEvents |
| XML usage count | 0 |
...
- RoR_SoR: RoR_SoR.Enable -> RegisterEventHandler(SystemData.Events.ALL_MODULES_INITIALIZED, RoR_SoR.Enable)
