...
- CallingSetup.OnRButtonUp
- RegisterEventHandler
- global

## Examples

- Calling: RegisterEventHandler -> SystemData.Events.R_BUTTON_UP_PROCESSED -> CallingSetup.OnRButtonUp
- Calling: CallingSetup.OnRButtonUp -> RegisterEventHandler(SystemData.Events.R_BUTTON_UP_PROCESSED, CallingSetup.OnRButtonUp)
