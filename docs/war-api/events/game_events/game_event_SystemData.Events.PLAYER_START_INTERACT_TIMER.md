...
- Effigy.Name..".StartInteract"
- RegisterEventHandler
- global

## Examples

- Effigy: Effigy.RegisterStateInfoForCastbar -> SystemData.Events.PLAYER_START_INTERACT_TIMER -> Effigy.Name..".StartInteract"
- Effigy: Effigy.Name..".StartInteract" -> RegisterEventHandler(SystemData.Events.PLAYER_START_INTERACT_TIMER, Effigy.Name..".StartInteract")
