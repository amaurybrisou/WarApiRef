...
- Enemy: Enemy.GroupsInitialize -> SystemData.Events.PLAYER_MAX_ACTION_POINTS_UPDATED -> Enemy.Groups_OnCurrentPlayerUpdated
- Enemy: Enemy.Groups_OnCurrentPlayerUpdated -> RegisterEventHandler(SystemData.Events.PLAYER_MAX_ACTION_POINTS_UPDATED, Enemy.Groups_OnCurrentPlayerUpdated)
