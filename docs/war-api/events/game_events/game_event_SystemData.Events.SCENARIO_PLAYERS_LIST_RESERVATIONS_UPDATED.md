...
- Enemy: Enemy.GroupsInitialize -> SystemData.Events.SCENARIO_PLAYERS_LIST_RESERVATIONS_UPDATED -> Enemy.GroupsUpdate
- Enemy: Enemy.GroupsUpdate -> RegisterEventHandler(SystemData.Events.SCENARIO_PLAYERS_LIST_RESERVATIONS_UPDATED, Enemy.GroupsUpdate)
