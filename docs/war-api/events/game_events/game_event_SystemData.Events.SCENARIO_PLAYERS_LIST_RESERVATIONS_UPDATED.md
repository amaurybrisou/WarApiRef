...
- SquaredScenario.FlagUpdate
- global

## Examples

- Squared: RegisterEventHandler -> SystemData.Events.SCENARIO_PLAYERS_LIST_RESERVATIONS_UPDATED -> SquaredScenario.FlagUpdate
- Squared: SquaredScenario.FlagUpdate -> RegisterEventHandler(SystemData.Events.SCENARIO_PLAYERS_LIST_RESERVATIONS_UPDATED, SquaredScenario.FlagUpdate)
