...
- LoyalPet: LPET.Initialize -> EA_CareerResourceWindow -> SystemData.Events.R_BUTTON_DOWN_PROCESSED
- LoyalPet: SystemData.Events.R_BUTTON_DOWN_PROCESSED -> RegisterEventHandler(EA_CareerResourceWindow, SystemData.Events.R_BUTTON_DOWN_PROCESSED)
