...
- CurseProfiler.untillocal
- RegisterEventHandler
- global

## Examples

- ZCurse_Profiler: CurseProfiler.Initialize -> SystemData.Events.QUEST_INFO_UPDATED -> CurseProfiler.untillocal
- ZCurse_Profiler: CurseProfiler.untillocal -> RegisterEventHandler(SystemData.Events.QUEST_INFO_UPDATED, CurseProfiler.untillocal)
