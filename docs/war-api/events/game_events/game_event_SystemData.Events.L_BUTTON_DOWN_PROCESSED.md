...
- AdvancedPetAssist.OnLButtonDown
- RegisterEventHandler
- global

## Examples

- AdvancedPetAssist: AdvancedPetAssist.local.RegisterCoreEvents -> SystemData.Events.L_BUTTON_DOWN_PROCESSED -> AdvancedPetAssist.OnLButtonDown
- AdvancedPetAssist: RegisterCoreEvents -> SystemData.Events.L_BUTTON_DOWN_PROCESSED -> AdvancedPetAssist.OnLButtonDown
- AdvancedPetAssist: AdvancedPetAssist.OnLButtonDown -> RegisterEventHandler(SystemData.Events.L_BUTTON_DOWN_PROCESSED, AdvancedPetAssist.OnLButtonDown)
