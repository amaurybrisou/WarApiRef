...
- QuickTacticSwitch: QTS.Initialize -> SystemData.Events.PLAYER_ACTIVE_TACTICS_UPDATED -> QTS.TacticsUpdated
- QuickTacticSwitch: QTS.TacticsUpdated -> RegisterEventHandler(SystemData.Events.PLAYER_ACTIVE_TACTICS_UPDATED, QTS.TacticsUpdated)
