...
| Namespaces detected | selffriendlytarget |
...
- Effigy: Effigy.RegisterStateInfoForTargets -> selffriendlytarget -> Effigy.OnRangeUpdated_TargetsCallback
- Effigy: Effigy.OnRangeUpdated_TargetsCallback -> RegisterEventHandler(selffriendlytarget, Effigy.OnRangeUpdated_TargetsCallback)
...
- [LibUnits.Events.PLAYER_FRIENDLY_TARGET_UPDATED](game_event_LibUnits.Events.PLAYER_FRIENDLY_TARGET_UPDATED.md) (HIGH 73/100) - Game Event
