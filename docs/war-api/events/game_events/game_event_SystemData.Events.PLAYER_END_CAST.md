...
- Effigy: Effigy.RegisterStateInfoForCastbar -> SystemData.Events.PLAYER_END_CAST -> Effigy.Name..".EndCast"
- TurretRange: TurretRange.Initialize -> SystemData.Events.PLAYER_END_CAST -> TurretRange.OnCastEnd
- Effigy: Effigy.Name..".EndCast" -> RegisterEventHandler(SystemData.Events.PLAYER_END_CAST, Effigy.Name..".EndCast")
