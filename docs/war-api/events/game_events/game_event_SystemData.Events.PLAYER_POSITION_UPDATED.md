...
- CurseProfiler.untilfunction
- RegisterEventHandler
- global

## Examples

- ZCurse_Profiler: CurseProfiler.Initialize -> SystemData.Events.PLAYER_POSITION_UPDATED -> CurseProfiler.untilfunction
- ZCurse_Profiler: CurseProfiler.untilfunction -> RegisterEventHandler(SystemData.Events.PLAYER_POSITION_UPDATED, CurseProfiler.untilfunction)
