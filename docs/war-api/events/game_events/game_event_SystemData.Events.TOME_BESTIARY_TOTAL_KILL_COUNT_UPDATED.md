...
- CurseProfiler.untilelseif
- RegisterEventHandler
- global

## Examples

- ZCurse_Profiler: CurseProfiler.Initialize -> SystemData.Events.TOME_BESTIARY_TOTAL_KILL_COUNT_UPDATED -> CurseProfiler.untilelseif
- ZCurse_Profiler: CurseProfiler.untilelseif -> RegisterEventHandler(SystemData.Events.TOME_BESTIARY_TOTAL_KILL_COUNT_UPDATED, CurseProfiler.untilelseif)
