...
- PartyCast.SetbackCast
- RegisterEventHandler
- global

## Examples

- PartyCast: PartyCast.Init -> SystemData.Events.PLAYER_CAST_TIMER_SETBACK -> PartyCast.SetbackCast
- PartyCast: PartyCast.SetbackCast -> RegisterEventHandler(SystemData.Events.PLAYER_CAST_TIMER_SETBACK, PartyCast.SetbackCast)
