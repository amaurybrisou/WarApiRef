...
- SquaredGroup.UpdateGroupStatus
- global

## Examples

- Squared: RegisterEventHandler -> SystemData.Events.GROUP_STATUS_UPDATED -> SquaredGroup.UpdateGroupStatus
- Squared: SquaredGroup.UpdateGroupStatus -> RegisterEventHandler(SystemData.Events.GROUP_STATUS_UPDATED, SquaredGroup.UpdateGroupStatus)
