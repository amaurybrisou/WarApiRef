...
- Enemy.Intercom_OnBroadcastMessageInvite
- addon

## Examples

- Enemy: Enemy.IntercomInitialize -> BroadcastMessageInvite -> Enemy.Intercom_OnBroadcastMessageInvite
- Enemy: Enemy.Intercom_OnBroadcastMessageInvite -> Enemy.AddEventHandler(BroadcastMessageInvite, Enemy.Intercom_OnBroadcastMessageInvite)
