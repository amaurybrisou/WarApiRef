...
- Enemy: AddEventHandler -> BroadcastMessageInvite -> Enemy.Intercom_OnBroadcastMessageInvite
- Enemy: Enemy.Intercom_OnBroadcastMessageInvite -> AddEventHandler(BroadcastMessageInvite, Enemy.Intercom_OnBroadcastMessageInvite)
