...
- Effigy: Effigy.RegisterStateInfoForTargets -> LibUnits.Events.PLAYER_FRIENDLY_TARGET_UPDATED -> selffriendlytarget
- Effigy: selffriendlytarget -> RegisterEventHandler(LibUnits.Events.PLAYER_FRIENDLY_TARGET_UPDATED, selffriendlytarget)

## Related APIs

- [selffriendlytarget](game_event_selffriendlytarget.md) (MEDIUM 43/100) - Game Event
