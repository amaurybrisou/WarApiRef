...
- Enemy: Enemy.GroupsInitialize -> SystemData.Events.SCENARIO_GROUP_JOIN -> Enemy.GroupsUpdateType
- LibGuard: LibGuard.Init -> SystemData.Events.SCENARIO_GROUP_JOIN -> LibGuard.GROUP_UPDATED
- Enemy: Enemy.GroupsUpdateType -> RegisterEventHandler(SystemData.Events.SCENARIO_GROUP_JOIN, Enemy.GroupsUpdateType)
- LibGuard: LibGuard.GROUP_UPDATED -> RegisterEventHandler(SystemData.Events.SCENARIO_GROUP_JOIN, LibGuard.GROUP_UPDATED)
