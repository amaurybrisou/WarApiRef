...
- DAoCBuff: DAoCBuff.Initialize -> SystemData.Events.RELEASE_CORPSE -> DAoCBuff.TargetsCleared
- DAoCBuff: DAoCBuff.TargetsCleared -> RegisterEventHandler(SystemData.Events.RELEASE_CORPSE, DAoCBuff.TargetsCleared)
