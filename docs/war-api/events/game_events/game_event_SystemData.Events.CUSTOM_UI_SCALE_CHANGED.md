...
- DAoCBuff: DAoCBuff.Initialize -> SystemData.Events.CUSTOM_UI_SCALE_CHANGED -> DAoCBuff.U
- DAoCBuff: DAoCBuff.U -> RegisterEventHandler(SystemData.Events.CUSTOM_UI_SCALE_CHANGED, DAoCBuff.U)
