...
- CurseProfiler.fornil
- RegisterEventHandler
- global

## Examples

- ZCurse_Profiler: CurseProfiler.Initialize -> SystemData.Events.INTERACT_SHOW_LOOT -> CurseProfiler.fornil
- ZCurse_Profiler: CurseProfiler.fornil -> RegisterEventHandler(SystemData.Events.INTERACT_SHOW_LOOT, CurseProfiler.fornil)
