...
- CurseProfiler.truebreak
- RegisterEventHandler
- global

## Examples

- ZCurse_Profiler: CurseProfiler.Initialize -> SystemData.Events.INTERACT_SHOW_QUEST -> CurseProfiler.truebreak
- ZCurse_Profiler: CurseProfiler.truebreak -> RegisterEventHandler(SystemData.Events.INTERACT_SHOW_QUEST, CurseProfiler.truebreak)
