...
- Squared: RegisterEventHandler -> SystemData.Events.SCENARIO_PLAYERS_LIST_GROUPS_UPDATED -> SquaredScenario.FlagUpdate
- Squared: SquaredScenario.FlagUpdate -> RegisterEventHandler(SystemData.Events.SCENARIO_PLAYERS_LIST_GROUPS_UPDATED, SquaredScenario.FlagUpdate)
