...
| Files seen in | `/workspace/data/raw/DAoCBuff/Source/DAoCBuff.lua:25` |
...
- DAoCBuff: DAoCBuff.Initialize -> SystemData.Events.PLAYER_DEATH_CLEARED -> DAoCBuff.TargetsCleared
- DAoCBuff: DAoCBuff.TargetsCleared -> RegisterEventHandler(SystemData.Events.PLAYER_DEATH_CLEARED, DAoCBuff.TargetsCleared)
