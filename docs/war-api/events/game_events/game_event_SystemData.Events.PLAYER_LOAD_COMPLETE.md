...
- GoldTracker.OnPlayerLoaded
- RegisterEventHandler

## Examples

- GoldTracker: GoldTracker.OnPlayerLoaded -> RegisterEventHandler(SystemData.Events.PLAYER_LOAD_COMPLETE, GoldTracker.OnPlayerLoaded)
