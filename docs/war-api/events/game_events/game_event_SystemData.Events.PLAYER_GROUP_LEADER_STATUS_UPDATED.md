...
| Example locations | followTheLeader: followTheLeader.Initialize |
| XML usage count | 0 |
...
- followTheLeader: followTheLeader.Initialize -> SystemData.Events.PLAYER_GROUP_LEADER_STATUS_UPDATED -> followTheLeader.RequestUpdate
- followTheLeader: followTheLeader.RequestUpdate -> RegisterEventHandler(SystemData.Events.PLAYER_GROUP_LEADER_STATUS_UPDATED, followTheLeader.RequestUpdate)
