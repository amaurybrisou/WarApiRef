...
| Files seen in | `/workspace/data/raw/Enemy/Code/Assist/Assist.lua:7` |
...
- Enemy: Enemy.AssistInitialize -> IntercomMessage -> Enemy.Assist_OnIntercomMessage
- Enemy: Enemy.Assist_OnIntercomMessage -> Enemy.AddEventHandler(IntercomMessage, Enemy.Assist_OnIntercomMessage)
