...
- ZCurse_Profiler: CurseProfiler.Initialize -> SystemData.Events.INTERACT_SHOW_INFLUENCE_REWARDS -> CurseProfiler.ordo
- ZCurse_Profiler: CurseProfiler.ordo -> RegisterEventHandler(SystemData.Events.INTERACT_SHOW_INFLUENCE_REWARDS, CurseProfiler.ordo)
