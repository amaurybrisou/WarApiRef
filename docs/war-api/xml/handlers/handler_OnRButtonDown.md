...
| Evidence | Value |
| --- | --- |
| Addons seen in | BuffHead, Calling, Enemy, HealGrid, LibAddonButton, MarkBuff, Obsidian, Sequencer |
...
- BuffHead: .OnRButtonDown -> BuffHead.Setup.SelectTexture.OnTextureRowRDown
- BuffHead: .OnRButtonDown -> BuffHead.Setup.AdvancedCompression.OnRowRDown
- BuffHead: .OnRButtonDown -> BuffHead.Setup.AdvancedCompressionItem.OnRowRDown
- BuffHead: .OnRButtonDown -> BuffHead.Setup.AdvancedContainers.OnRowRDown
- BuffHead: .OnRButtonDown -> BuffHead.Setup.Layout.OnLayoutWindowRButtonDown
- BuffHead: .OnRButtonDown -> BuffHead.Setup.Layout.TrapClick
