...
| Evidence | Value |
| --- | --- |
| Addons seen in | AdjustTheTip, Atlas, Aura, Bloody Mess, BuffHead, CCTV, CDown, ChattyCathy |
| Files seen in | Code/UnitFrames/EffectsIndicatorDialog.xml, Configuration/Main.xml, Gui/HealGridGuiTabBattlegroup.xml, Gui/HealGridGuiTabGroup.xml, Gui/HealGridGuiTabHUD.xml, Gui/HealGridGuiTabHUDBuffs.xml, Gui/HealGridGuiTabScenariogroup.xml, Gui/HealGridGuiTemplates.xml |
| Namespaces detected | SliderBar |
| Source kinds | xml_frames |
| Example locations | AdjustTheTip: AdjustTheTipMenuItemSliderSliderBar, Atlas: AtlasConfigurationFrameContentMapSettingsTransparencyOnMouseOverSlider, Atlas: AtlasConfigurationFrameContentMapSettingsTransparencyOnMovementSlider, Atlas: AtlasConfigurationFrameContentMapSettingsTransparencySlider, Atlas: TAtlasSlider, Aura: AuraColorPickerAlpha |
| XML usage count | 227 |
| XML attribute usage count | 227 |
| Lua usage count | 0 |
...
SliderBar is an interactive XML control. It commonly appears under Button and Window. It is typically used to organize structural children such as Anchors, EventHandlers, Size and bind XML events like OnLButtonUp, OnMouseOver, OnSlide to Lua.
...
- Obsidian.Setup.SelectColor.OnSlideTint
- TastyButtonsOptions.OnSlidingColor
...
- WarBoard_FPSOptions.OnSlidingColor
- SOROptions.Slide
- Atlas.Configuration.OnSlide
...
- CDownSettings.OnSlideABCBlue
- CDownSettings.OnSlideABCGreen
- CDownSettings.OnSlideABCRed
- CDownSettings.OnSlideLength
- CDownSettings.OnSlideSCBlue
- CDownSettings.OnSlideSCGreen
- CDownSettings.OnSlideSCRed
...
- DetauntBarSettings.OnHeightSlide
- DetauntBarSettings.OnScaleSlide
- DetauntBarSettings.OnWidthSlide
- DuffTimer.Options.OnSliderChange
- GroupRangeSetup.General.OnSlideUpdateDelay
- GroupSpotter.Settings.SlidergrpAlpha
- GroupSpotter.Settings.SlidersingleAlpha
...
- HealGridGuiTabBattlegroup.BuffUpdateThrottleChanged
- HealGridGuiTabBattlegroup.UnitFrameHeightChanged
- HealGridGuiTabBattlegroup.UnitFrameScaleChanged
- HealGridGuiTabBattlegroup.UnitFrameWidthChanged
- HealGridGuiTabBattlegroup.UpdateThrottleChanged
- HealGridGuiTabGroup.BuffUpdateThrottleChanged
- HealGridGuiTabGroup.UnitFrameHeightChanged
- HealGridGuiTabGroup.UnitFrameScaleChanged
- HealGridGuiTabGroup.UnitFrameWidthChanged
- HealGridGuiTabGroup.UpdateThrottleChanged
- HealGridGuiTabHUD.BuffUpdateThrottleChanged
- HealGridGuiTabHUD.UnitFrameHeightChanged
- HealGridGuiTabHUD.UnitFrameScaleChanged
- HealGridGuiTabHUD.UnitFrameWidthChanged
- HealGridGuiTabHUD.UpdateThrottleChanged
- HealGridGuiTabHUDBuffs.BuffFrameSizeAdjustChanged
- HealGridGuiTabHUDBuffs.ShowBuffsMaxChanged
- HealGridGuiTabScenariogroup.BuffUpdateThrottleChanged
- HealGridGuiTabScenariogroup.NumGroupsDisplayedChanged
- HealGridGuiTabScenariogroup.UnitFrameHeightChanged
- HealGridGuiTabScenariogroup.UnitFrameScaleChanged
- HealGridGuiTabScenariogroup.UnitFrameWidthChanged
- HealGridGuiTabScenariogroup.UpdateThrottleChanged
...
- RVAPI_Range.OnSlideMapDelay
- RVMOD_Manager.OnSlideFadeInOutDelay
- RVMOD_Manager.OnSlideScale
- RVMOD_Manager.OnSlideZoomInOutDelay
- RVMOD_SquaredDistances.OnSlideDistancesDelay
- RVMOD_SquaredDistances.OnSlideScale
...
- ScenarioGroupWindow.OnOpacitySlide
- ShiniesConfigGeneral.OnSlide_UIScale
- Statdoll.Options.onAlphaSlide
- Statdoll.Options.onScaleSlide
- TacticSetNames.SettingsWindow.OnSlide
- TastyButtonsOptions.OnSlidingCeateView
- TastyButtonsOptions.OnSlidingEditView
...
|-------|----------|---------------------|-------------------|-----------------|
| [OnSlide](../handlers/handler_OnSlide.md) | custom | snt_panel.slider_change, snt_info.slider_change, AuraColorPicker.OnSlide, Enemy.UnitFramesUI_EffectsIndicatorDialog_UpdateExample, GroupIconsSG.OptionsSliderMove, BuffHead.Setup.SelectColor.OnSlideTint, MapMonster.PinTypeEditor.OnSetCustomColor, MoraleCircle.OnSetCustomColor, MoraleCircle.OnSetCustomColorEmpty, MoraleCircle.OnSetCustomColorFill, MoraleCircle.OnSetCustomColorFull, Obsidian.Setup.SelectColor.OnSlideTint, TastyButtonsOptions.OnSlidingColor, TexturedButtons.Setup.SelectColor.OnSlideTint, TexturedButtons.Setup.Tint.OnSlideTint, TurretRange.Setup.Display.OnSlideTint, TurretRange.Setup.Distance.OnSlideTint, WSCT.OnSetCustomColor, WarBoard_FPSOptions.OnSlidingColor, SOROptions.Slide, Atlas.Configuration.OnSlide, AuraConfig.OnTextureRotationSlide, AuraConfig.OnTextureScaleSlide, AuraConfig.OnTimerScaleSlide, BuffHead.Setup.AdvancedContainersItem.Properties.OnSlideScale, BuffHead.Setup.Container.OnSlideColumns, BuffHead.Setup.Container.OnSlidePaddingHorizontal, BuffHead.Setup.Container.OnSlidePaddingVertical, BuffHead.Setup.Container.OnSlideRows, BuffHead.Setup.Display.OnSlideIndicatorScale, BuffHead.Setup.Display.OnSlidePaddingHorizontal, BuffHead.Setup.Display.OnSlidePaddingVertical, BuffHead.Setup.General.OnSlideMaximumThreshold, BuffHead.Setup.Layout.Properties.OnSlideAlphaAlpha, BuffHead.Setup.Layout.Properties.OnSlideIconBorderAlpha, BuffHead.Setup.Layout.Properties.OnSlideSizeScale, BuffHead.Setup.Layout.Properties.OnSlideStatusBarBackgroundAlpha, BuffHead.Setup.Layout.Properties.OnSlideStatusBarForegroundAlpha, BuffHead.Setup.Performance.OnSlideGeneralUpdateDelay, BuffHead.Setup.Performance.OnSlideMaximumUpdates, BuffHead.Setup.Performance.OnSlidePriorityUpdateDelay, BuffHead.Setup.Performance.OnSlidePriorityUpdateStart, BuffHead.Setup.Performance.OnSlideResyncTargetDelay, CDownSettings.OnSlideABCBlue, CDownSettings.OnSlideABCGreen, CDownSettings.OnSlideABCRed, CDownSettings.OnSlideLength, CDownSettings.OnSlideSCBlue, CDownSettings.OnSlideSCGreen, CDownSettings.OnSlideSCRed, ChattyCathy.OnSlideAlpha, DAoCBuffSettings.FilterSettings.OnSlideBB, DAoCBuffSettings.FilterSettings.OnSlideBG, DAoCBuffSettings.FilterSettings.OnSlideBR, DAoCBuffSettings.FilterSettings.OnSlideCB, DAoCBuffSettings.FilterSettings.OnSlideCG, DAoCBuffSettings.FilterSettings.OnSlideCR, DetauntBarSettings.OnHeightSlide, DetauntBarSettings.OnScaleSlide, DetauntBarSettings.OnWidthSlide, DuffTimer.Options.OnSliderChange, GroupRangeSetup.General.OnSlideUpdateDelay, GroupSpotter.Settings.SlidergrpAlpha, GroupSpotter.Settings.SlidersingleAlpha, GroupSpotter.Settings.colorslidergrpB, GroupSpotter.Settings.colorslidergrpG, GroupSpotter.Settings.colorslidergrpR, GroupSpotter.Settings.colorslidersingleB, GroupSpotter.Settings.colorslidersingleG, GroupSpotter.Settings.colorslidersingleR, HealGridGuiTabBattlegroup.BuffUpdateThrottleChanged, HealGridGuiTabBattlegroup.UnitFrameHeightChanged, HealGridGuiTabBattlegroup.UnitFrameScaleChanged, HealGridGuiTabBattlegroup.UnitFrameWidthChanged, HealGridGuiTabBattlegroup.UpdateThrottleChanged, HealGridGuiTabGroup.BuffUpdateThrottleChanged, HealGridGuiTabGroup.UnitFrameHeightChanged, HealGridGuiTabGroup.UnitFrameScaleChanged, HealGridGuiTabGroup.UnitFrameWidthChanged, HealGridGuiTabGroup.UpdateThrottleChanged, HealGridGuiTabHUD.BuffUpdateThrottleChanged, HealGridGuiTabHUD.UnitFrameHeightChanged, HealGridGuiTabHUD.UnitFrameScaleChanged, HealGridGuiTabHUD.UnitFrameWidthChanged, HealGridGuiTabHUD.UpdateThrottleChanged, HealGridGuiTabHUDBuffs.BuffFrameSizeAdjustChanged, HealGridGuiTabHUDBuffs.ShowBuffsMaxChanged, HealGridGuiTabScenariogroup.BuffUpdateThrottleChanged, HealGridGuiTabScenariogroup.NumGroupsDisplayedChanged, HealGridGuiTabScenariogroup.UnitFrameHeightChanged, HealGridGuiTabScenariogroup.UnitFrameScaleChanged, HealGridGuiTabScenariogroup.UnitFrameWidthChanged, HealGridGuiTabScenariogroup.UpdateThrottleChanged, LibGroup.Setup.OnSlideGroupDistanceCacheUpdate, LibGroup.Setup.OnSlideGroupDistanceSearchUpdate, LibGroup.Setup.OnSlideGroupUpdateDelay, MapPin.onRotateSlide, MapPin.onScaleSlide, Obsidian.Setup.Castbar.OnSlideBackgroundAlpha, Obsidian.Setup.Castbar.OnSlideFillAlpha, Obsidian.Setup.Castbar.OnSlideGlobalCooldownBackgroundAlpha, Obsidian.Setup.Castbar.OnSlideGlobalCooldownDividerAlpha, Obsidian.Setup.Castbar.OnSlideGlobalCooldownFillAlpha, Obsidian.Setup.Castbar.OnSlideGlobalCooldownFillReadyAlpha, Obsidian.Setup.Castbar.OnSlideGlobalCooldownSparkAlpha, Obsidian.Setup.Castbar.OnSlideIconAlpha, Obsidian.Setup.Castbar.OnSlideIconScale, Obsidian.Setup.Castbar.OnSlideLatencyAlpha, Obsidian.Setup.Castbar.OnSlideLatencyTextAlpha, Obsidian.Setup.Castbar.OnSlideLatencyTextScale, Obsidian.Setup.Castbar.OnSlideNameAlpha, Obsidian.Setup.Castbar.OnSlideNameScale, Obsidian.Setup.Castbar.OnSlideNameWidth, Obsidian.Setup.Castbar.OnSlideSparkAlpha, Obsidian.Setup.Castbar.OnSlideTimerAlpha, Obsidian.Setup.Castbar.OnSlideTimerDecimals, Obsidian.Setup.Castbar.OnSlideTimerScale, Obsidian.Setup.EffectTracker.OnSlideBackgroundAlpha, Obsidian.Setup.EffectTracker.OnSlideFillAlpha, Obsidian.Setup.EffectTracker.OnSlideNameAlpha, Obsidian.Setup.EffectTracker.OnSlideNameScale, Obsidian.Setup.EffectTracker.OnSlideNameWidth, Obsidian.Setup.EffectTracker.OnSlideTimerAlpha, Obsidian.Setup.EffectTracker.OnSlideTimerScale, Obsidian.Setup.EffectTracker.OnSlideTrackerIconAlpha, Obsidian.Setup.EffectTracker.OnSlideTrackerIconScale, Obsidian.Setup.EffectTracker.OnSlideTrackerMaximumEffects, PotionBarSettings.OnAlphaSliderChanged, PotionBarSettings.OnScaleSliderChanged, RVAPI_ColorDialog.OnSlide, RVAPI_Range.OnSlideMapDelay, RVMOD_Manager.OnSlideFadeInOutDelay, RVMOD_Manager.OnSlideScale, RVMOD_Manager.OnSlideZoomInOutDelay, RVMOD_SquaredDistances.OnSlideDistancesDelay, RVMOD_SquaredDistances.OnSlideScale, ReliquaryHunterOptionsWindow.OnWorldMapWindowBackgroundOpacitySlide, ReliquaryHunterOptionsWindow.OnWorldMapWindowOpacitySlide, RoR_SoR.OnSlideWindowOptionsOffset, RoR_SoR.OnSlideWindowOptionsOpacity, RoR_SoR.OnSlideWindowOptionsScale, ScenarioGroupWindow.OnOpacitySlide, ShiniesConfigGeneral.OnSlide_UIScale, Statdoll.Options.onAlphaSlide, Statdoll.Options.onScaleSlide, TacticSetNames.SettingsWindow.OnSlide, TastyButtonsOptions.OnSlidingCeateView, TastyButtonsOptions.OnSlidingEditView, TexturedButtons.Setup.Cooldown.OnSlideCooldownAlpha, TurretRange.Setup.Display.OnSlideDistanceScale, TurretRange.Setup.General.OnSlideUpdateDelay, WSCT.SliderOnSlide, WarBoard.Options.OnSlide, XpStatus.OnOpacitySlide | `sliderPos` | LOW |
| [OnLButtonUp](../handlers/handler_OnLButtonUp.md) | input | alertMod.OnSliderChanged | `flags, x, y` | MEDIUM |
| [OnMouseOver](../handlers/handler_OnMouseOver.md) | input | WSCT.OnMouseOver | `` |  |

### Per-Event Lua API Calls

**OnSlide** handlers call: `ButtonGetPressedFlag`, `ComboBoxGetSelectedMenuItem`, `LabelSetText`, `LabelSetTextColor`, `SliderBarGetCurrentPosition`, `SliderBarSetCurrentPosition`, `TextEditBoxGetText`, `TextEditBoxSetText`, `WindowGetAlpha`, `WindowGetDimensions`, `WindowGetId`, `WindowGetParent`, `WindowGetScale`, `WindowSetAlpha`, `WindowSetDimensions`, `WindowSetScale`, `WindowSetTintColor`, `WindowStartAlphaAnimation`
...
- [Windows](element_Windows.md) — 225× (HIGH)
- [Window](element_Window.md) — 2× (LOW)

## Common Structural Child Elements

- [Anchors](element_Anchors.md) — 219× (HIGH)
- [EventHandlers](element_EventHandlers.md) — 205× (HIGH)
...
| --- | --- | --- | --- |
| `inherits` | **required** | 95% | EA_Default_SliderBar, TAtlasSlider, Aura_Default_SliderBar, HGG_SliderFullLabels, ... |
| `numticks` | optional | 34% | 10, 360, 250, 200, ... |
| `locktoticks` | optional | 12% | false |
| `handleinput` | optional | 5% | true |
| `background` | optional | 4% | EA_BrownHorizontalRule |
| `sliderbutton` | optional | 4% | Aura_Default_SliderButton, EA_Default_SliderButton, DetauntHelper_Config_SB |
| `tickmark` | optional | 4% | Aura_Default_SliderTick, EA_Default_SliderTick2, DetauntHelper_Config_ST |
| `autoresize` | optional | 2% | true |
| `handlinput` | optional | 2% | true |
| `numTicks` | optional | 1% | 11 |
| `scale` | optional | 1% | 0.4 |
## Structural Sub-Elements

### [Anchors](element_Anchors.md)

Observed 219 times as an unnamed child.

### [EventHandlers](element_EventHandlers.md)

Observed 205 times as an unnamed child.
...
| --- | --- | --- | --- |
| `SliderBarGetCurrentPosition` | ui | 325 | OnSlide |
| `LabelSetText` | ui | 123 | OnSlide |
| `TextEditBoxSetText` | ui | 55 | OnSlide |
| `TextEditBoxGetText` | ui | 36 | OnSlide |
| `ComboBoxGetSelectedMenuItem` | ui | 28 | OnSlide |
| `WindowSetTintColor` | ui | 18 | OnSlide |
| `SliderBarSetCurrentPosition` | ui | 15 | OnSlide |
| `ButtonGetPressedFlag` | ui | 12 | OnSlide |
| `LabelSetTextColor` | ui | 9 | OnSlide |
| `WindowSetScale` | ui | 7 | OnSlide |
| `WindowGetDimensions` | ui | 5 | OnSlide |
| `WindowSetAlpha` | ui | 5 | OnSlide |
| `WindowGetParent` | ui | 4 | OnMouseOver, OnSlide |
| `WindowGetScale` | ui | 2 | OnSlide |
| `WindowSetDimensions` | ui | 2 | OnSlide |
| `WindowGetAlpha` | ui | 1 | OnSlide |
| `WindowGetId` | ui | 1 | OnSlide |
| `WindowStartAlphaAnimation` | ui | 1 | OnSlide |
...
- Total handler declarations: 206
- Resolved to Lua functions: 206 (100%)
...
- AdjustTheTip: AdjustTheTipMenuItemSliderSliderBar -> SliderBar AdjustTheTipMenuItemSliderSliderBar
- Atlas: AtlasConfigurationFrameContentMapSettingsTransparencyOnMouseOverSlider -> SliderBar AtlasConfigurationFrameContentMapSettingsTransparencyOnMouseOverSlider
- Atlas: AtlasConfigurationFrameContentMapSettingsTransparencyOnMovementSlider -> SliderBar AtlasConfigurationFrameContentMapSettingsTransparencyOnMovementSlider
- Atlas: AtlasConfigurationFrameContentMapSettingsTransparencySlider -> SliderBar AtlasConfigurationFrameContentMapSettingsTransparencySlider
- Atlas: TAtlasSlider -> SliderBar TAtlasSlider
...
- [OnSlide](../handlers/handler_OnSlide.md) (HIGH 88/100) - XML Event
