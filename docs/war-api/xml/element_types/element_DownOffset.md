...
| Namespaces detected | DownOffset |
...
DownOffset is a XML UI element. It commonly appears under VerticalScrollbar.
...
- EA_UiDebugTools: EA_ScrollBar_ChatVertical -> DownOffset in VerticalScrollbar EA_ScrollBar_ChatVertical
- SpamBayes: SpamBayesWindowLogTextScrollbar -> DownOffset in VerticalScrollbar SpamBayesWindowLogTextScrollbar
