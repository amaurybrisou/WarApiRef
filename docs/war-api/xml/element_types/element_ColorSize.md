...
ColorSize is a XML UI element. It commonly appears under ColorPicker.
...
- WSCT: WSCTOptionsColorPickerWindowColorPicker -> ColorSize in ColorPicker WSCTOptionsColorPickerWindowColorPicker
