...
TopCenter is a XML UI element. It commonly appears under TexCoords and TexSlices.
...
| `y` | optional | 63% | 571, 157, 669, 0, ... |
| `id` | optional | 36% | Action-Bar-Frame-Top-Center, Border-Top-Center |
## Seen In
