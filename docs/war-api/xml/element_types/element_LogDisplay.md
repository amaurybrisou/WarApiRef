...
| Evidence | Value |
| --- | --- |
| Addons seen in | EA_UiDebugTools, Shinies, SpamBayes |
| Files seen in | Modules/UI/Shinies-UI-Auto.xml, Source/DebugWindow.xml |
| Namespaces detected | LogDisplay |
| Source kinds | xml_frames |
| Example locations | EA_UiDebugTools: DebugWindowText, Shinies: ShiniesAutoUI_AutoSummary, SpamBayes: SpamBayesWindowLogText |
| XML usage count | 3 |
...
LogDisplay is an interactive XML control. It commonly appears under Window. It is typically used to organize structural children such as Anchors, EventHandlers, Size and bind XML events like OnHyperLinkRButtonUp to Lua.
...
- EA_ChatWindow.OnHyperLinkRButtonUpChatWindowOnly
...
|-------|----------|---------------------|-------------------|-----------------|
| OnHyperLinkRButtonUp | custom | EA_ChatWindow.OnHyperLinkRButtonUpChatWindowOnly | `` |  |
...
| `font` | **required** | 100% | font_clear_small_bold, font_chat_text, font_journal_body |
| `maxchars` | **required** | 100% | 4096 |
| `maxentries` | **required** | 100% | -1, 256 |
| `scrollbar` | **required** | 100% | $parentScrollbar, SpamBayesWindowLogTextScrollbar |
| `scrollbarPosition` | **required** | 100% | right |
| `autoHideScrollBar` | optional | 33% | true |
| `handleinput` | optional | 33% | true |
| `textFadeTime` | optional | 33% | 30 |
...
- SpamBayes: SpamBayesWindowLogText -> LogDisplay SpamBayesWindowLogText
