...
| [OnMouseOver](../handlers/handler_OnMouseOver.md) | input | Enemy.ConfigurationWindow_ShowTooltip | `` |  |
...
- [Anchors](element_Anchors.md) — 139× (HIGH)
...
Observed 139 times as an unnamed child.
