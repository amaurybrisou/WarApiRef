...
| Files seen in | Core/Tome/DK_NFO.xml, Core/Tome/DK_TOK.xml, Core/Tome/DK_TOP.xml |
| Namespaces detected | PageWindow |
| Source kinds | xml_frames |
| Example locations | DammazKron: DammazKronNFOPageWindowL, DammazKron: DammazKronNFOPageWindowR, DammazKron: DammazKronTOKStats, DammazKron: DammazKronTOPPageWindow |
| XML usage count | 4 |
...
PageWindow is a container-style XML element. It commonly appears under Window. It is typically used to organize structural children such as Anchors, Size, Windows.
...
| --- | --- | --- | --- |
| `inherits` | **required** | 100% | TomePageWindow |
...
- Root: [PageWindow](element_PageWindow.md)
...
- DammazKron: DammazKronNFOPageWindowL -> PageWindow DammazKronNFOPageWindowL
- DammazKron: DammazKronNFOPageWindowR -> PageWindow DammazKronNFOPageWindowR
- DammazKron: DammazKronTOKStats -> PageWindow DammazKronTOKStats
- DammazKron: DammazKronTOPPageWindow -> PageWindow DammazKronTOPPageWindow
