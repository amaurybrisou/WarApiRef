...
| Files seen in | `/workspace/data/raw/InfoScroller/libs/LibGUI.lua:1096`, `/workspace/data/raw/PartyCast/libs/LibGUI.lua:1096` |
| Namespaces detected | ComboBoxGetDisabledFlag |
| Source kinds | lua_calls |
| Example locations | InfoScroller: LIBGUI_Combobox:Enabled, PartyCast: LIBGUI_Combobox:Enabled |
| XML usage count | 0 |
...
- InfoScroller: LIBGUI_Combobox:Enabled -> ComboBoxGetDisabledFlag(self.name)
