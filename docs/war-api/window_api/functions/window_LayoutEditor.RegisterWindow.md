...
| Evidence | Value |
| --- | --- |
| Addons seen in | AutoBand, BuffHead, Busted, CM_ClosetGoblin, DAoCBuff, Effigy, Enemy, GuardLine |
| Files seen in | `/workspace/Autoband/AutoBand.lua:30`, `/workspace/BuffHead/AdvancedContainers.lua:36`, `/workspace/Busted/Busted.lua:333`, `/workspace/ClosetGoblin/ClosetGoblinOptionWindow.lua:28`, `/workspace/DAoCBuff/Source/DAoCBuffFrames.lua:346`, `/workspace/DAoCBuff/Source/DAoCBuffHeadFrames.lua:122`, `/workspace/Effigy/Elements/EffigyBar.lua:58`, `/workspace/Enemy/Code/Assist/Assist.lua:7` |
| Namespaces detected | LayoutEditor |
| Source kinds | globals, lua_calls |
| Example locations | AutoBand: AutoBand.init, BuffHead: BuffHead.local.RegisterLayoutEditor, BuffHead: RegisterLayoutEditor, Busted: BustedGUI.Initialize, CM_ClosetGoblin: ClosetGoblinOptionWindow.OnInitialize, DAoCBuff: DAoCBuffHeadTracker:Create |
| XML usage count | 0 |
...
| Name | Role | Evidence |
| --- | --- | --- |
| arg1 | Observed as a text or wstring payload. | Observed values: "AutoBandMapIcon", "BustedMiniGUI", "ClosetGoblinOptionWindow" |
| arg2 | Observed as a text or wstring payload. | Observed values: L "", L "AutoBand", L "Busted" |
...
- AutoBand: AutoBand.init -> LayoutEditor.RegisterWindow("AutoBandMapIcon", L "AutoBand", L "AutoBand Button", false, false, true, nil)
