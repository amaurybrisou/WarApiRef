...
| Files seen in | `/workspace/data/raw/InfoScroller/libs/LibGUI.lua:213`, `/workspace/data/raw/PartyCast/libs/LibGUI.lua:213` |
| Namespaces detected | WindowGetFontAlpha |
| Source kinds | lua_calls |
| Example locations | InfoScroller: LIBGUI_ELEMENT:FontAlpha, PartyCast: LIBGUI_ELEMENT:FontAlpha |
| XML usage count | 0 |
...
- InfoScroller: LIBGUI_ELEMENT:FontAlpha -> WindowGetFontAlpha(self.name)
