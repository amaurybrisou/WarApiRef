...
| Example locations | EA_UiDebugTools: WindowInit |
| XML usage count | 0 |
...
- EA_UiDebugTools: WindowInit -> TextEditBoxSetHistory(ObjectInspector.Window.."CommandEditBox", ObjectInspector.history)
