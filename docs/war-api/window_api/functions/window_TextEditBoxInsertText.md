...
```lua
TextEditBoxInsertText(arg1, arg2)
```
...
| Name | Role | Evidence |
| --- | --- | --- |
| arg1 | Observed as a runtime window or control identifier. | Observed values: codeWindow |
| arg2 | Observed as a runtime window or control identifier. | Observed values: towstring "     " |
...
- EA_UiDebugTools: DevPadWindow.OnKeyTab -> TextEditBoxInsertText(codeWindow, towstring "     ")
