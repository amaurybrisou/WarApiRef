...
- Observed in contexts: Enemy.GroupsInitialize, Enemy.Groups_OnShowAlertText, GCDsaver.local.alertText, SystemData.Events.SHOW_ALERT_TEXT, alertText, event_page
