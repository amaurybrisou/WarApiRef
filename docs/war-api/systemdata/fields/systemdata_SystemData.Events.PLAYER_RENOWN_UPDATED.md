...
| Files seen in | `/workspace/data/raw/Killer/KillerLifecycle.lua:100`, `/workspace/data/raw/Killer/KillerLifecycle.lua:4` |
| Namespaces detected | SystemData |
| Source kinds | event_page, event_registration, flow, lua_call |
| Example locations | Killer.Initialize, Killer.OnRenownUpdated, Killer.Shutdown, SystemData.Events.PLAYER_RENOWN_UPDATED, event_page, event_registration |
| XML usage count | 0 |
...
- Observed in contexts: Killer.Initialize, Killer.OnRenownUpdated, Killer.Shutdown, SystemData.Events.PLAYER_RENOWN_UPDATED, event_page, event_registration
