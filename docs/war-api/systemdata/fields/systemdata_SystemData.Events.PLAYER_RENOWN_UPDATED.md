...
| Evidence | Value |
| --- | --- |
| Addons seen in | Effigy, Killer, RRCount |
| Files seen in | `/workspace/Effigy/States/EffigyStatePlayer.lua:45`, `/workspace/Killer/KillerLifecycle.lua:100`, `/workspace/Killer/KillerLifecycle.lua:4`, `/workspace/rrcount/rrcount.lua:36` |
| Namespaces detected | SystemData |
| Source kinds | event_page, event_registration, flow, lua_call |
| Example locations | Effigy.RegisterStateInfoForPlayer, Killer.Initialize, Killer.OnRenownUpdated, Killer.Shutdown, RrCount.Shutdown, SystemData.Events.PLAYER_RENOWN_UPDATED |
| XML usage count | 0 |
...
- [SystemData.Events.PLAYER_CURRENCY_SLOT_UPDATED](systemdata_SystemData.Events.PLAYER_CURRENCY_SLOT_UPDATED.md) (HIGH 100/100) - SystemData Field
...
- Observed in contexts: Effigy.RegisterStateInfoForPlayer, Killer.Initialize, Killer.OnRenownUpdated, Killer.Shutdown, RrCount.Shutdown, SystemData.Events.PLAYER_RENOWN_UPDATED
