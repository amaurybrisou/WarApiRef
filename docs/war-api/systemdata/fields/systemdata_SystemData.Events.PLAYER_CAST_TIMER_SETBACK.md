...
| Example locations | Effigy.Name..".SetbackCast", Effigy.RegisterStateInfoForCastbar, SystemData.Events.PLAYER_CAST_TIMER_SETBACK, event_page, event_registration, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: Effigy.Name..".SetbackCast", Effigy.RegisterStateInfoForCastbar, SystemData.Events.PLAYER_CAST_TIMER_SETBACK, event_page, event_registration, lua_call
