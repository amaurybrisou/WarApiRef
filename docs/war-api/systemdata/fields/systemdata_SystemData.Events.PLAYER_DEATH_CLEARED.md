...
| Example locations | DAoCBuff.Initialize, DAoCBuff.Shutdown, DAoCBuff.TargetsCleared, SystemData.Events.PLAYER_DEATH_CLEARED, event_page, event_registration |
| XML usage count | 0 |
...
- Observed in contexts: DAoCBuff.Initialize, DAoCBuff.Shutdown, DAoCBuff.TargetsCleared, SystemData.Events.PLAYER_DEATH_CLEARED, event_page, event_registration
