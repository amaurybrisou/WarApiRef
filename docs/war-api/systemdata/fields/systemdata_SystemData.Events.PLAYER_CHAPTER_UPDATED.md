...
| Evidence | Value |
| --- | --- |
| Addons seen in | CMap, EA_OpenPartyWindow |
| Files seen in | CMap.lua, source/openpartywindowtabnearby.lua |
...
SystemData.SystemData.Events.PLAYER_CHAPTER_UPDATED field accessed by 2 addons; commonly found in Initialize and lua_call contexts.
