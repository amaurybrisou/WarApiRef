...
| Files seen in | `/workspace/data/raw/TidyRoll/TidyRoll.lua:632` |
| Namespaces detected | SystemData |
| Source kinds | lua_call |
| Example locations | TidyRoll.UpdateTooltip, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: TidyRoll.UpdateTooltip, lua_call
