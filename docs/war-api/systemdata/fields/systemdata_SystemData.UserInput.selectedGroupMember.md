...
| Files seen in | SquaredWarband.lua, no-useless-mods-warband.lua |
...
SystemData.SystemData.UserInput.selectedGroupMember field accessed by 2 addons; commonly found in OnMenuClickAssistMember and OnMenuClickGroupKick, OnMenuClickMakeLeader, OnMenuClickTargetMember, OnMenuClickTellMember, lua_call contexts.
