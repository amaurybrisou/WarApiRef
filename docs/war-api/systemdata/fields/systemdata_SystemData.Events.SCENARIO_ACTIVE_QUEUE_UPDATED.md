...
| Evidence | Value |
| --- | --- |
| Addons seen in | CMap, Minmap, QueuePopTimer, TidyQueue |
| Files seen in | CMap.lua, QueuePopTimer.lua, TidyQueue.lua, core.lua |
...
SystemData.SystemData.Events.SCENARIO_ACTIVE_QUEUE_UPDATED field accessed by 4 addons; commonly found in Initialize and lua_call contexts.
