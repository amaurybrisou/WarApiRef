...
| Evidence | Value |
| --- | --- |
| Addons seen in | NaturalLog, WSCT, WarBoard_Session, XpStatus+G |
| Files seen in | Handler.lua, WarBoard_Session.lua, source/XpStatus.lua, wsct.lua |
| Namespaces detected | SystemData |
| Source kinds | lua_call |
| Example locations | Init, Initialize, OnInitialize, RegisterSelfEvents, Shutdown, UnregisterSelfEvents |
| XML usage count | 0 |
...
SystemData.SystemData.Events.WORLD_OBJ_RENOWN_GAINED field accessed by 4 addons; commonly found in Init and Initialize, OnInitialize, RegisterSelfEvents, Shutdown, UnregisterSelfEvents, lua_call contexts.
...
- Observed in contexts: Init, Initialize, OnInitialize, RegisterSelfEvents, Shutdown, UnregisterSelfEvents
