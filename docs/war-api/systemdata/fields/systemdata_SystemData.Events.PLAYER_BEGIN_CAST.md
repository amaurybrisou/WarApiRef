...
- AdvancedPetAssist
- AdvancedPetAssist, Effigy, LibGuard, TurretRange
- Effigy
- LibGuard
- LoyalPet
- TurretRange
...
- Observed in contexts: AdvancedPetAssist.OnPlayerCast, Effigy.Name..".StartCast", Effigy.RegisterStateInfoForCastbar, LPET.Initialize, LPET.Shutdown, LibGuard.Init
