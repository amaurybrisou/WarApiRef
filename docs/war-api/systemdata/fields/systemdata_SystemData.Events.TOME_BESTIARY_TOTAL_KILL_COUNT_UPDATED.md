...
| Example locations | CurseProfiler.Initialize, CurseProfiler.untilelseif, SystemData.Events.TOME_BESTIARY_TOTAL_KILL_COUNT_UPDATED, event_page, event_registration, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: CurseProfiler.Initialize, CurseProfiler.untilelseif, SystemData.Events.TOME_BESTIARY_TOTAL_KILL_COUNT_UPDATED, event_page, event_registration, lua_call
