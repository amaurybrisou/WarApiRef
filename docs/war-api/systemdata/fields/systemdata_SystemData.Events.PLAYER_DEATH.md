...
| Evidence | Value |
| --- | --- |
| Addons seen in | Effigy, Effigy, PlanB, PlanB |
| Files seen in | `/workspace/Effigy/States/EffigyStatePlayer.lua:45`, `/workspace/PlanB/PlanB.lua:35` |
| Namespaces detected | SystemData |
| Source kinds | event_page, event_registration, flow, lua_call |
| Example locations | Effigy.OnPlayerDeath, Effigy.RegisterStateInfoForPlayer, PlanB.Initialize, PlanB.SetPage, SystemData.Events.PLAYER_DEATH, event_page |
| XML usage count | 0 |
...
- [SystemData.Events.PLAYER_CAREER_RESOURCE_UPDATED](systemdata_SystemData.Events.PLAYER_CAREER_RESOURCE_UPDATED.md) (HIGH 100/100) - SystemData Field
...
- Observed in contexts: Effigy.OnPlayerDeath, Effigy.RegisterStateInfoForPlayer, PlanB.Initialize, PlanB.SetPage, SystemData.Events.PLAYER_DEATH, event_page
