...
- Observed in contexts: Effigy.local.OnMenuClickLeaveGroup, LibGuard.GROUP_UPDATED, LibGuard.Init, LibGuard.OnShutdown, OnMenuClickLeaveGroup, SystemData.Events.GROUP_LEAVE
