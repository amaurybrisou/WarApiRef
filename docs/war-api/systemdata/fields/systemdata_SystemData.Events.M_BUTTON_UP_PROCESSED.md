...
| Evidence | Value |
| --- | --- |
| Addons seen in | BuddyBind, Calling |
| Files seen in | BuddyBind.lua, CallingKeybinding.lua |
| Namespaces detected | SystemData |
| Source kinds | lua_call |
| Example locations | OnExitBindingMode, OnLButtonRawDeviceInput, OnRawDeviceInput, StartBinding, lua_call |
| XML usage count | 0 |
...
SystemData.SystemData.Events.M_BUTTON_UP_PROCESSED field accessed by 2 addons; commonly found in OnExitBindingMode and OnLButtonRawDeviceInput, OnRawDeviceInput, StartBinding, lua_call contexts.
...
- Observed in contexts: OnExitBindingMode, OnLButtonRawDeviceInput, OnRawDeviceInput, StartBinding, lua_call
