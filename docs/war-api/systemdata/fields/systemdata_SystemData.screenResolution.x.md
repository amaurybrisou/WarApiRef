...
- [SystemData.screenResolution.y](systemdata_SystemData.screenResolution.y.md) (HIGH 100/100) - SystemData Field
...
- Observed in contexts: Effigy.LoadLayout, lua_call
