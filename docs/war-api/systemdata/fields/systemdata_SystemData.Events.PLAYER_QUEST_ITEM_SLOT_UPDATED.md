...
| Example locations | CurseProfiler.Initialize, CurseProfiler.elsewhile, SystemData.Events.PLAYER_QUEST_ITEM_SLOT_UPDATED, event_page, event_registration, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: CurseProfiler.Initialize, CurseProfiler.elsewhile, SystemData.Events.PLAYER_QUEST_ITEM_SLOT_UPDATED, event_page, event_registration, lua_call
