...
- Observed in contexts: FastInteract.HealAll, FastInteract.Initialize, FastInteract.OnShutdown, HealAll.Heal, HealAll.Initialize, SystemData.Events.INTERACT_SHOW_HEALER
