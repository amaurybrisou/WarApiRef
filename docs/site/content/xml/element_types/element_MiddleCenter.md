...
MiddleCenter is a XML UI element. It commonly appears under TexCoords and TexSlices.
...
| --- | --- | --- | --- |
| `x` | optional | 64% | 272, 60, 356, 32, ... |
| `y` | optional | 64% | 172, 18, 680, 32, ... |
| `id` | optional | 35% | Border-Middle-Center |
## Seen In
