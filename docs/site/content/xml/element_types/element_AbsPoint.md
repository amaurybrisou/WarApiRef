...
- [Anchor](element_Anchor.md) — 3500× (HIGH)
- [Size](element_Size.md) — 2634× (HIGH)
- [Anchors](element_Anchors.md) — 3× (MEDIUM)

## Attribute Reference

| Attribute | Required | Usage % | Sample Values |
| --- | --- | --- | --- |
| `x` | **required** | 100% | 120, 220, 550, 0, ... |
| `y` | **required** | 99% | 28, 850, 0, 32, ... |
## Seen In
