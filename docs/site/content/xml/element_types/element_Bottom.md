...
| Files seen in | `/workspace_addons/ea_uidebugtools/Source/DebugWindowVerticalScroll.xml:80` |
| Namespaces detected | Bottom |
| Source kinds | xml_frames |
| Example locations | EA_UiDebugTools: EA_ScrollBar_ChatThumb |
| XML usage count | 1 |
...
- EA_UiDebugTools: EA_ScrollBar_ChatThumb -> Bottom in VerticalResizeImage EA_ScrollBar_ChatThumb
