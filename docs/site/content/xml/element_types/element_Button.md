...
| OnMouseDrag | input | EA_Window_Macro.IconMouseDrag, Enemy.AssistUI_ConfigDialog_OnMacroMarkMouseDrag, Enemy.AssistUI_ConfigDialog_OnMacroTargetMouseDrag, Enemy.ConfigurationWindow_OnMacroMouseDrag, Enemy.ScenarioInfoUI_ConfigDialog_OnMacroToggleMouseDrag | `flags, x, y` | LOW |
...
| --- | --- | --- | --- |
| `WindowSetShowing` | ui | 384 | OnLButtonDown, OnLButtonUp, OnMouseOver, OnMouseOverEnd, OnRButtonUp |
| `ButtonSetPressedFlag` | ui | 242 | OnEscapeProcessed, OnLButtonDown, OnLButtonUp |
| `WindowGetId` | ui | 233 | OnLButtonDown, OnLButtonUp, OnMouseOver, OnRButtonDown, OnRButtonUp |
| `ComboBoxGetSelectedMenuItem` | ui | 140 | OnLButtonUp, OnMouseOver |
| `TextEditBoxGetText` | ui | 106 | OnLButtonDown, OnLButtonUp |
| `WindowGetShowing` | ui | 92 | OnLButtonUp, OnRButtonUp |
...
| `LabelSetText` | ui | 71 | OnLButtonUp, OnMouseOver |
| `ButtonGetPressedFlag` | ui | 67 | OnLButtonDown, OnLButtonUp |
| `TextEditBoxSetText` | ui | 66 | OnLButtonDown, OnLButtonUp |
| `ButtonGetDisabledFlag` | ui | 63 | OnLButtonDown, OnLButtonUp, OnMouseOver |
| `WindowGetParent` | ui | 50 | OnLButtonDown, OnLButtonUp, OnMouseOver, OnRButtonUp |
| `WindowSetTintColor` | ui | 30 | OnLButtonDown, OnLButtonUp, OnRButtonUp |
| `WindowAddAnchor` | ui | 29 | OnLButtonDown, OnLButtonUp |
| `WindowSetDimensions` | ui | 29 | OnLButtonUp |
| `DoesWindowExist` | ui | 26 | OnLButtonDown, OnLButtonUp |
...
| `WindowClearAnchors` | ui | 19 | OnLButtonDown, OnLButtonUp |
| `ListBoxGetDataIndex` | ui | 18 | OnLButtonDown, OnLButtonUp, OnMouseOver, OnRButtonUp |
| `Cursor.Clear` | ui | 12 | OnLButtonDown, OnLButtonUp |
| `CreateWindow` | ui | 11 | OnInitialize, OnLButtonUp |
| `Cursor.IconOnCursor` | data | 11 | OnLButtonDown, OnLButtonUp, OnMouseDrag |
| `DynamicImageSetTexture` | ui | 10 | OnLButtonDown, OnLButtonUp, OnRButtonUp |
| `ButtonGetText` | ui | 9 | OnLButtonUp |
| `ButtonSetText` | ui | 9 | OnLButtonUp |
| `ListBoxSetDisplayOrder` | ui | 9 | OnLButtonUp |
| `SystemData.MouseOverWindow.name:match` | data | 9 | OnLButtonUp, OnMouseOver, OnRButtonUp |
| `WindowUtils.BeginResize` | ui | 9 | OnLButtonDown |
...
| `WindowSetAlpha` | ui | 8 | OnLButtonUp, OnMouseOver, OnRButtonUp |
| `WindowSetLayer` | ui | 8 | OnRButtonUp |
| `WindowUtils.ToggleShowing` | ui | 8 | OnLButtonUp, OnRButtonUp |
| `WindowSetHandleInput` | ui | 7 | OnLButtonUp |
| `WindowSetScale` | ui | 7 | OnLButtonUp |
...
| `Cursor.PickUp` | data | 4 | OnLButtonDown, OnLButtonUp, OnMouseDrag |
