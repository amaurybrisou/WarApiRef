...
UpOffset is a XML UI element. It commonly appears under VerticalScrollbar.
...
- EA_UiDebugTools: EA_ScrollBar_ChatVertical -> UpOffset in VerticalScrollbar EA_ScrollBar_ChatVertical
- SpamBayes: SpamBayesWindowLogTextScrollbar -> UpOffset in VerticalScrollbar SpamBayesWindowLogTextScrollbar
