...
| Evidence | Value |
| --- | --- |
| Addons seen in | CCTV, KeyBar, MoraleCircle, Pure, Swinger, TastyButtons, WhatsCooking |
| Files seen in | CustomTextures/TastyButtonsButtonTemplate.xml, Source/PureUIElementTemplates.xml |
| Namespaces detected | CooldownDisplay |
| Source kinds | xml_frames |
| Example locations | CCTV: CCTVRootWindowICONBorderAbilityCooldown, CCTV: CCTVSnareWindowICONBorderAbilityCooldown, CCTV: CCTVStaggerWindowICONBorderAbilityCooldown, KeyBar: KeyBarButtonAbilityCooldown, MoraleCircle: MoraleTemplateAbilityCooldown, Pure: PureEffectIconSpinner |
| XML usage count | 10 |
...
CooldownDisplay is a container-style XML element. It commonly appears under Button and Window. It is typically used to organize structural children such as Anchors, Size, Windows and be manipulated from Lua by functions such as CCTV.Update, WhatsCooking.Initialize.
...
- [Windows](element_Windows.md) — 10× (HIGH)

## Common Structural Child Elements

- [Anchors](element_Anchors.md) — 10× (HIGH)
...
| `cooldownshape` | optional | 40% | circle |
| `segments` | optional | 40% | 8, 32 |
| `alpha` | optional | 10% | 0.75 |
| `movable` | optional | 10% | true |
| `popable` | optional | 10% | false |
| `sticky` | optional | 10% | true |
...
- CCTV: CCTVRootWindowICONBorderAbilityCooldown -> CooldownDisplay CCTVRootWindowICONBorderAbilityCooldown
- CCTV: CCTVSnareWindowICONBorderAbilityCooldown -> CooldownDisplay CCTVSnareWindowICONBorderAbilityCooldown
- CCTV: CCTVStaggerWindowICONBorderAbilityCooldown -> CooldownDisplay CCTVStaggerWindowICONBorderAbilityCooldown
- KeyBar: KeyBarButtonAbilityCooldown -> CooldownDisplay KeyBarButtonAbilityCooldown
- MoraleCircle: MoraleTemplateAbilityCooldown -> CooldownDisplay MoraleTemplateAbilityCooldown
- Pure: PureEffectIconSpinner -> CooldownDisplay PureEffectIconSpinner
