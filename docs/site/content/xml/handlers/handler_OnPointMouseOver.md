...
| Evidence | Value |
| --- | --- |
| Addons seen in | Atlas, Map, Minmap |
| Namespaces detected | OnPointMouseOver |
| Source kinds | bindings, xml_handlers |
| Example locations | Atlas: .OnPointMouseOver, Map: .OnPointMouseOver, Minmap: .OnPointMouseOver |
| XML usage count | 0 |
...
XML handler event observed across 3 addons.
