...
| Namespaces detected | OnFocusLost |
| Source kinds | bindings, xml_handlers |
| Example locations | FastFriends: .OnFocusLost, MegaphonePlusPlus: .OnFocusLost |
| XML usage count | 0 |
...
- FastFriends: .OnFocusLost -> FastFriends.UI.OnMinLevelCommit
- MegaphonePlusPlus: .OnFocusLost -> Megaphone.SaveSettings
