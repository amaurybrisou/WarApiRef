...
| Example locations | lua_call, test |
| XML usage count | 0 |
...
GameData.GameData.Sound.QUEST_ABANDONED field accessed by 1 addons; commonly found in lua_call and test contexts.
...
- Observed in contexts: lua_call, test
