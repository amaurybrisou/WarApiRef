...
- Observed in contexts: Effigy.UpdatePlayerHP, Effigy.local.SetupCareerIcon, SetupCareerIcon, WSCT:CreateCareerStrings, lua_call, wbLeadHelper.gatherGroupPlayers
