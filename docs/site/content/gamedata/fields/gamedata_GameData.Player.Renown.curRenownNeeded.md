...
| Files seen in | `/workspace_addons/Effigy/States/EffigyStatePlayer.lua:342` |
| Namespaces detected | GameData |
| Source kinds | lua_call |
| Example locations | Effigy.UpdateRenown, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: Effigy.UpdateRenown, lua_call
