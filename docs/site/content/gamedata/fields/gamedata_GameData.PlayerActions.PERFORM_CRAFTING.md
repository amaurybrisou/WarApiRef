...
| Files seen in | `/workspace/data/raw/MiracleGrowLight/MiracleGrowLight.lua:301` |
| Namespaces detected | GameData |
| Source kinds | lua_call |
| Example locations | MiracleGrowLight.Initialize, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: MiracleGrowLight.Initialize, lua_call
