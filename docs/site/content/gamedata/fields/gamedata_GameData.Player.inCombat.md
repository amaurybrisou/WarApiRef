...
| Files seen in | `/workspace/data/raw/AdvancedPetAssist/APAEvents.lua:165` |
| Namespaces detected | GameData |
| Source kinds | lua_call |
| Example locations | AdvancedPetAssist.OnPetUpdated, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: AdvancedPetAssist.OnPetUpdated, lua_call
