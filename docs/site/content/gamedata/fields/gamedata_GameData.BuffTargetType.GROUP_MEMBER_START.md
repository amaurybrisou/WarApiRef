...
| Files seen in | CleanGroupMemberUnitFrame.lua |
| Namespaces detected | GameData |
| Source kinds | lua_call |
| Example locations | Create, lua_call |
| XML usage count | 0 |
...
GameData.GameData.BuffTargetType.GROUP_MEMBER_START field accessed by 1 addons; commonly found in Create and lua_call contexts.
