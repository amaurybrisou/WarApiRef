...
| Files seen in | `/workspace/data/raw/RoR_SoR/RoR_SoR.lua:2468` |
| Namespaces detected | GameData |
| Source kinds | lua_call |
| Example locations | RoR_SoR.ContextMenu1, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: RoR_SoR.ContextMenu1, lua_call
