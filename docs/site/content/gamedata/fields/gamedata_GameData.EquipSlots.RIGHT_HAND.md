...
| Files seen in | `/workspace_addons/Effigy/States/EffigyStatePlayer.lua:158` |
| Namespaces detected | GameData |
| Source kinds | lua_call |
| Example locations | Effigy.GetWeaponSwingSpeed, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: Effigy.GetWeaponSwingSpeed, lua_call
