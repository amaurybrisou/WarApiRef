...
- Observed in contexts: Effigy.UpdatePlayerPet, EnemyPlayer:LoadPetFromCurrentPlayer, GuardLine.GetIDs, LibGuard.UpdatePetHealthProxy, LibGuard.UpdateStateMachine, lua_call
