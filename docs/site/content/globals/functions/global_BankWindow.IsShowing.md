...
| Files seen in | BagOMatic.lua, Source/BankWindowFix.lua |
| Namespaces detected | BankWindow |
| Source kinds | lua_calls |
| Example locations | BagOMatic: cmd_sortall, BankWindowFix: BagEquipmentRButtonUp |
| XML usage count | 0 |
...
- BagOMatic: cmd_sortall -> BankWindow.IsShowing()
- BankWindowFix: BagEquipmentRButtonUp -> BankWindow.IsShowing()
