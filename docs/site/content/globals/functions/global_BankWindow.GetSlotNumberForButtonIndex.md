...
```lua
BankWindow.GetSlotNumberForButtonIndex(arg1)
```
...
| Name | Role | Evidence |
| --- | --- | --- |
| arg1 | Observed as a runtime window or control identifier. | Observed values: buttonIndex |
...
- BankWindowFix: BankWindowFix.BankEquipmentRButtonDown -> BankWindow.GetSlotNumberForButtonIndex(buttonIndex)
