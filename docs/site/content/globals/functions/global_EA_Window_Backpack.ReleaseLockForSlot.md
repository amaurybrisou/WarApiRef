...
| Name | Role | Evidence |
| --- | --- | --- |
| arg1 | Observed as a runtime window or control identifier. | Observed values: CreateAuctionWindow.itemInventorySlot.slot, slotB |
| arg2 | Observed as a function or method reference. | Observed values: CreateAuctionWindow.itemInventorySlot.backpack, backpack |
