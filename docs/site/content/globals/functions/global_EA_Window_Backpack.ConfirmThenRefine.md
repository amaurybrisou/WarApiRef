...
```lua
EA_Window_Backpack.ConfirmThenRefine(arg1, arg2)
```
...
- BankWindowFix: BankWindowFix.BagEquipmentRButtonUp -> EA_Window_Backpack.ConfirmThenRefine(slot, EA_Window_Backpack.currentMode)
