...
| Example locations | AdvancedRenownTrainer: GetPointsSpent, AdvancedRenownTrainer: Initialize, AdvancedRenownTrainer: OnShown, AdvancedRenownTrainer: UpdatePointsLabel |
| XML usage count | 0 |
...
- AdvancedRenownTrainer: UpdatePointsLabel -> EA_Window_InteractionRenownTraining.GetPointsSpent()
...
- [EA_Window_InteractionRenownTraining.GetPointsAvailable](global_EA_Window_InteractionRenownTraining.GetPointsAvailable.md) (HIGH 98/100) - Global Function
