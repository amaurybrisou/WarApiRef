...
```lua
EA_ChatWindow.UpdateTabScrollWindow(arg1)
```
...
| Name | Role | Evidence |
| --- | --- | --- |
| arg1 | Observed as a runtime window or control identifier. | Observed values: wndGroupId |
...
- TidyChat: TidyChatCore.SetWindowTabs -> EA_ChatWindow.UpdateTabScrollWindow(wndGroupId)
