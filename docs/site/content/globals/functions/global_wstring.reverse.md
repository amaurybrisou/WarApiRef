...
| Files seen in | `/workspace/QueueQueuer/QueueQueuer.lua:338` |
| Namespaces detected | wstring |
| Source kinds | lua_calls |
| Example locations | Queue Queuer: QueueQueuer.FixName |
| XML usage count | 0 |
...
| Name | Role | Evidence |
| --- | --- | --- |
| arg1 | Observed as a runtime window or control identifier. | Observed values: name |
...
- Queue Queuer: QueueQueuer.FixName -> wstring.reverse(name)
