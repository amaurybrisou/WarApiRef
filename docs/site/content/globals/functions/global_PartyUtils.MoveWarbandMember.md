...
| Evidence | Value |
| --- | --- |
| Addons seen in | Hopper |
| Files seen in | Source/Hopper.lua |
| Namespaces detected | PartyUtils |
| Source kinds | lua_calls |
| Example locations | Hopper: SetGroup |
| XML usage count | 0 |
...
| arg2 | Observed as a runtime window or control identifier. | Observed values: groupIndex |
