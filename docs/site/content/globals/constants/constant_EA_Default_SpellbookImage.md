...
| Evidence | Value |
| --- | --- |
| Addons seen in | DPSMeter |
| Files seen in | DPSMeterWindow.xml |
| Namespaces detected | EA_Default_SpellbookImage |
| Source kinds | xml_attributes |
| Example locations | DPSMeterWindowCornorImage |
| XML usage count | 1 |
