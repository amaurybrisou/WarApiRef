...
| Evidence | Value |
| --- | --- |
| Addons seen in | RealmStatus, Shinies |
| Files seen in | RealmStatusHistoryWindow.xml, Source/Shinies.xml |
| Namespaces detected | EA_HorizontalResizeImage_DefaultTopFrame |
| Source kinds | xml_attributes |
| Example locations | RealmStatusHistoryWindowTitleBarBackground, Shinies_TitleBar_DefaultBackground |
| XML usage count | 2 |
...
- RealmStatusHistoryWindowTitleBarBackground
- Shinies_TitleBar_DefaultBackground
