...
| Example locations | DAoCBuff.Initialize, DAoCBuff.Shutdown, DAoCBuff.U, SystemData.Events.CUSTOM_UI_SCALE_CHANGED, event_page, event_registration |
| XML usage count | 0 |
...
- Observed in contexts: DAoCBuff.Initialize, DAoCBuff.Shutdown, DAoCBuff.U, SystemData.Events.CUSTOM_UI_SCALE_CHANGED, event_page, event_registration
