...
| Evidence | Value |
| --- | --- |
| Addons seen in | AbilityAlert, Bloody Mess, Calling, CombatTextNames, DPSMeter, Effigy, LoyalPet, NaturalLog |
| Files seen in | AbilityAlert.lua, Bloody Mess.lua, CallingEvents.lua, CallingTargetMarker.lua, CurseProfilerCompiled.lua, DPSMeter.lua, Handler.lua, LoyalPet.lua |
...
SystemData.SystemData.Events.WORLD_OBJ_COMBAT_EVENT field accessed by 17 addons; commonly found in Calling.OnCombatEvent and Disable, Enable, HideWorldTextWindow, Init, Initialize, OnInitialize, OnShutdown, OnSkavenStatusChange, RegisterSelfEvents, RegisterStateInfoForCastbar, RetAlert_Disable, RetAlert_Enable, SetShowMarker, Shutdown, SystemData.Events.WORLD_OBJ_COMBAT_EVENT, UnregisterSelfEvents, event_page, event_registration, lua_call contexts.
