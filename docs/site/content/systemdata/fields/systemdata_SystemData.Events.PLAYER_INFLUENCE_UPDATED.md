...
| Evidence | Value |
| --- | --- |
| Addons seen in | BarText (Influence), CMap, Effigy, xHUD |
| Files seen in | BarText_Influence.lua, CMap.lua, States/EffigyStatePlayer.lua, xHUD.lua |
...
SystemData.SystemData.Events.PLAYER_INFLUENCE_UPDATED field accessed by 4 addons; commonly found in Initialize and OnInitialize, RegisterStateInfoForPlayer, lua_call contexts.
