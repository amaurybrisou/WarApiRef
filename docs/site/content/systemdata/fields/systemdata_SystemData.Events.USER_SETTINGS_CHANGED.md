...
- Observed in contexts: RVMOD_Manager.Initialize, RVMOD_Manager.OnUserSettingsChanged, RVMOD_Manager.Shutdown, SystemData.Events.USER_SETTINGS_CHANGED, TexturedButtons.OnLoadComplete, TexturedButtons.OnSettingsChanged
