...
| Example locations | Enemy.ScenarioInfoUpdate, Enemy._ScenarioInfoEnabledChanged, SystemData.Events.SCENARIO_UPDATE_POINTS, event_page, event_registration, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: Enemy.ScenarioInfoUpdate, Enemy._ScenarioInfoEnabledChanged, SystemData.Events.SCENARIO_UPDATE_POINTS, event_page, event_registration, lua_call
