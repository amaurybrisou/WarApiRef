...
| Evidence | Value |
| --- | --- |
| Addons seen in | CDown |
| Files seen in | CDown.lua |
...
SystemData.SystemData.Events.PLAYER_COOLDOWN_TIMER_SET field accessed by 1 addons; commonly found in Initialize and Shutdown, lua_call contexts.
