...
| Evidence | Value |
| --- | --- |
| Addons seen in | BlackBook, Effigy, Killer, SessionRPs, TomeTracker, XpStatus+G, xHUD |
| Files seen in | BlackBook.lua, KillerLifecycle.lua, Source/TomeTracker_Journal.lua, States/EffigyStatePlayer.lua, source/XpStatus.lua, srp.lua, xHUD.lua |
| Namespaces detected | SystemData |
| Source kinds | lua_call |
| Example locations | Initialize, OnInitialize, RegisterStateInfoForPlayer, Shutdown, lua_call |
| XML usage count | 0 |
...
SystemData.SystemData.Events.PLAYER_RENOWN_UPDATED field accessed by 7 addons; commonly found in Initialize and OnInitialize, RegisterStateInfoForPlayer, Shutdown, lua_call contexts.
...
- Observed in contexts: Initialize, OnInitialize, RegisterStateInfoForPlayer, Shutdown, lua_call
