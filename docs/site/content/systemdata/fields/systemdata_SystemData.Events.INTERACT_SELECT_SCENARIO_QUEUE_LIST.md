...
| Files seen in | `/workspace/QueueQueuer/QueueQueuer.lua:773` |
| Namespaces detected | SystemData |
| Source kinds | lua_call |
| Example locations | QueueQueuer.OnUpdate, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: QueueQueuer.OnUpdate, lua_call
