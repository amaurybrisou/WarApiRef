...
| Example locations | PotionBar.Initialize, PotionBar.OnPlayerRenownRankUpdated, PotionBar.Shutdown, SystemData.Events.PLAYER_RENOWN_RANK_UPDATED, event_page, event_registration |
| XML usage count | 0 |
...
- Observed in contexts: PotionBar.Initialize, PotionBar.OnPlayerRenownRankUpdated, PotionBar.Shutdown, SystemData.Events.PLAYER_RENOWN_RANK_UPDATED, event_page, event_registration
