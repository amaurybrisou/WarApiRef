...
| Example locations | CurseProfiler.Initialize, CurseProfiler.breakfor, SystemData.Events.PLAYER_ABILITIES_LIST_UPDATED, event_page, event_registration, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: CurseProfiler.Initialize, CurseProfiler.breakfor, SystemData.Events.PLAYER_ABILITIES_LIST_UPDATED, event_page, event_registration, lua_call
