...
| Evidence | Value |
| --- | --- |
| Addons seen in | ActionFraction, ArmorGraphicToggle, AutoBand, BBars - Mechanic Only, CDown, CaVES, CastSequence, ClickSoundSuppressor |
| Files seen in | ArmorGraphicToggle.lua, AutoBand.lua, BBars.lua, CDown.lua, ClickSoundSuppressor.lua, Code/Core/Main.lua, CoolDownLine.lua, Core.lua |
...
- [SystemData.Events.GROUP_LEAVE](systemdata_SystemData.Events.GROUP_LEAVE.md) (HIGH 100/100) - SystemData Field
- [RegisterEventHandler](../../globals/functions/global_RegisterEventHandler.md) (MEDIUM 68/100) - Global Function
- [Start](../../events/game_events/game_event_Start.md) (MEDIUM 43/100) - Game Event
