...
| Example locations | CurseProfiler.Initialize, CurseProfiler.untillocal, SystemData.Events.QUEST_INFO_UPDATED, event_page, event_registration, lua_call |
| XML usage count | 0 |
...
- Observed in contexts: CurseProfiler.Initialize, CurseProfiler.untillocal, SystemData.Events.QUEST_INFO_UPDATED, event_page, event_registration, lua_call
