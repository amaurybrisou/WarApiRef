...
SystemData.SystemData.Events.CITY_SCENARIO_END field accessed by 5 addons; commonly found in GroupsInitialize and Initialize, Squared.ChangeMode, SystemData.Events.CITY_SCENARIO_END, event_page, event_registration, lua_call contexts.
