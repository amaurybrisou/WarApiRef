...
SystemData.SystemData.MousePosition.y field accessed by 7 addons; commonly found in GetMapPos and LayoutEndDrag, LayoutStartDrag, LayoutUpdate, OnLMouseButton, OnMouseOverEnd, OnUpdate, OnWindowOptionsSetScale, SetWindowAlphaByMousePosition, UpdateMapCoordinates, lua_call contexts.
