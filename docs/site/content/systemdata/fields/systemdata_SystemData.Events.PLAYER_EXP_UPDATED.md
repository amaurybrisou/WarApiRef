...
| Evidence | Value |
| --- | --- |
| Addons seen in | Effigy, XpStatus+G, xHUD |
| Files seen in | States/EffigyStatePlayer.lua, source/XpStatus.lua, xHUD.lua |
...
SystemData.SystemData.Events.PLAYER_EXP_UPDATED field accessed by 3 addons; commonly found in Initialize and OnInitialize, RegisterStateInfoForPlayer, Shutdown, lua_call contexts.
