...
| Example locations | QTS.Initialize, QTS.TacticsUpdated, SystemData.Events.PLAYER_ACTIVE_TACTICS_UPDATED, event_page, event_registration, flow |
| XML usage count | 0 |
...
- Observed in contexts: QTS.Initialize, QTS.TacticsUpdated, SystemData.Events.PLAYER_ACTIVE_TACTICS_UPDATED, event_page, event_registration, flow
