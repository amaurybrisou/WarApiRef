...
| Example locations | GCDsaver.PLAYER_TARGET_IS_IMMUNE_TO_MOVEMENT_IMPARING, GCDsaver.RegisterEvents, GCDsaver.UnregisterEvents, SystemData.Events.PLAYER_TARGET_IS_IMMUNE_TO_MOVEMENT_IMPARING, event_page, event_registration |
| XML usage count | 0 |
...
- Observed in contexts: GCDsaver.PLAYER_TARGET_IS_IMMUNE_TO_MOVEMENT_IMPARING, GCDsaver.RegisterEvents, GCDsaver.UnregisterEvents, SystemData.Events.PLAYER_TARGET_IS_IMMUNE_TO_MOVEMENT_IMPARING, event_page, event_registration
