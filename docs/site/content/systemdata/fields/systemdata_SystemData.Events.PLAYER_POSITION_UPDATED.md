...
- BuffHead
- BuffHead, MapMonster, TurretRange
- MapMonster
- TurretRange
...
- Observed in contexts: BuffHead.Initialize, BuffHead.OnPlayerPositionUpdated, MapMonster.InitializePlayer, MapMonster.OnPlayerPositionUpdated, MapMonster.ShutdownPlayer, SystemData.Events.PLAYER_POSITION_UPDATED
