...
| Files seen in | `/workspace/data/raw/InfoScroller/libs/LibGUI.lua:115`, `/workspace/data/raw/PartyCast/libs/LibGUI.lua:115` |
| Namespaces detected | WindowForceProcessAnchors |
| Source kinds | lua_calls |
| Example locations | InfoScroller: LIBGUI_ELEMENT:ProcessAnchors, PartyCast: LIBGUI_ELEMENT:ProcessAnchors |
| XML usage count | 0 |
...
- InfoScroller: LIBGUI_ELEMENT:ProcessAnchors -> WindowForceProcessAnchors(self.name)
