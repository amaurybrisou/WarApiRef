...
- CurseProfiler.breakelse
- RegisterEventHandler
- global

## Examples

- ZCurse_Profiler: CurseProfiler.Initialize -> SystemData.Events.INTERACT_COMPLETE_QUEST -> CurseProfiler.breakelse
- ZCurse_Profiler: CurseProfiler.breakelse -> RegisterEventHandler(SystemData.Events.INTERACT_COMPLETE_QUEST, CurseProfiler.breakelse)
