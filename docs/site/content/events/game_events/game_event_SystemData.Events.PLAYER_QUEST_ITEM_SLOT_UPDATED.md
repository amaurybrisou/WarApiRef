...
- CurseProfiler.elsewhile
- RegisterEventHandler
- global

## Examples

- ZCurse_Profiler: CurseProfiler.Initialize -> SystemData.Events.PLAYER_QUEST_ITEM_SLOT_UPDATED -> CurseProfiler.elsewhile
- ZCurse_Profiler: CurseProfiler.elsewhile -> RegisterEventHandler(SystemData.Events.PLAYER_QUEST_ITEM_SLOT_UPDATED, CurseProfiler.elsewhile)
