...
| Namespaces detected | windowName |
| Source kinds | event_page, lua_event_registration |
| Example locations | Vectors: Register |
| XML usage count | 0 |
...
- Vectors: Register -> windowName -> windowName
- Vectors: windowName -> Register(windowName, windowName)
