...
- ShiniesDataInventory.OnPlayerBankSlotUpdated

## Examples

- Shinies: ShiniesDataInventory.OnPlayerBankSlotUpdated -> RegisterEventHandler(SystemData.Events.PLAYER_BANK_SLOT_UPDATED, ShiniesDataInventory.OnPlayerBankSlotUpdated)
