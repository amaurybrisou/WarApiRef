...
- Enemy: AddEventHandler -> ChatTextArrived -> Enemy.Intercom_OnChatTextArrived
- Enemy: Enemy.Intercom_OnChatTextArrived -> AddEventHandler(ChatTextArrived, Enemy.Intercom_OnChatTextArrived)
