...
- Effigy.OnRangeUpdated_FormationCallback
- RegisterEventHandler
- global

## Examples

- Effigy: Effigy.UpdateFormationMember -> formation -> Effigy.OnRangeUpdated_FormationCallback
- Effigy: Effigy.UpdatePartyMember -> formation -> Effigy.OnRangeUpdated_FormationCallback
- Effigy: Effigy.OnRangeUpdated_FormationCallback -> RegisterEventHandler(formation, Effigy.OnRangeUpdated_FormationCallback)
