...
- CurseProfiler.andnot
- RegisterEventHandler
- global

## Examples

- ZCurse_Profiler: CurseProfiler.Initialize -> SystemData.Events.PUBLIC_QUEST_UPDATED -> CurseProfiler.andnot
- ZCurse_Profiler: CurseProfiler.andnot -> RegisterEventHandler(SystemData.Events.PUBLIC_QUEST_UPDATED, CurseProfiler.andnot)
