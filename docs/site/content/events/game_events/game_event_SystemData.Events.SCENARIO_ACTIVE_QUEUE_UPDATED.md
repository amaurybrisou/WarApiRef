...
- TidyQueue: TidyQueue.Initialize -> SystemData.Events.SCENARIO_ACTIVE_QUEUE_UPDATED -> TidyQueue.UpdateScenarioQueueData
- TidyQueue: TidyQueue.UpdateScenarioQueueData -> RegisterEventHandler(SystemData.Events.SCENARIO_ACTIVE_QUEUE_UPDATED, TidyQueue.UpdateScenarioQueueData)
