...
- PotionBar.OnPlayerRenownRankUpdated
- RegisterEventHandler
- global

## Examples

- PotionBar: PotionBar.Initialize -> SystemData.Events.PLAYER_RENOWN_RANK_UPDATED -> PotionBar.OnPlayerRenownRankUpdated
- PotionBar: PotionBar.OnPlayerRenownRankUpdated -> RegisterEventHandler(SystemData.Events.PLAYER_RENOWN_RANK_UPDATED, PotionBar.OnPlayerRenownRankUpdated)
