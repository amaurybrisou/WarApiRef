...
- ZCurse_Profiler: CurseProfiler.Initialize -> SystemData.Events.PLAYER_SINGLE_ABILITY_UPDATED -> CurseProfiler.breakfor
- ZCurse_Profiler: CurseProfiler.breakfor -> RegisterEventHandler(SystemData.Events.PLAYER_SINGLE_ABILITY_UPDATED, CurseProfiler.breakfor)
