...
- AdvancedPetAssist.OnPetTargetUpdated
- RegisterEventHandler
- global

## Examples

- AdvancedPetAssist: AdvancedPetAssist.local.RegisterCoreEvents -> SystemData.Events.PLAYER_PET_TARGET_UPDATED -> AdvancedPetAssist.OnPetTargetUpdated
- AdvancedPetAssist: RegisterCoreEvents -> SystemData.Events.PLAYER_PET_TARGET_UPDATED -> AdvancedPetAssist.OnPetTargetUpdated
- AdvancedPetAssist: AdvancedPetAssist.OnPetTargetUpdated -> RegisterEventHandler(SystemData.Events.PLAYER_PET_TARGET_UPDATED, AdvancedPetAssist.OnPetTargetUpdated)
