...
| Files seen in | TortallDPSCore.lua |
| Namespaces detected | Global |
| Source kinds | event_page, lua_event_registration |
| Example locations | TortallDPSCore: Register |
| XML usage count | 0 |
...
- TortallDPSCore: Register -> Global -> Global
- TortallDPSCore: Global -> Register(Global, Global)
