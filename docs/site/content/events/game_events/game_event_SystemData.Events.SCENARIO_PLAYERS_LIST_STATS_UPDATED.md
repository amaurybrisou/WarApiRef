...
- Enemy: Enemy._ScenarioInfoEnabledChanged -> SystemData.Events.SCENARIO_PLAYERS_LIST_STATS_UPDATED -> Enemy.ScenarioInfoUpdate
- Enemy: Enemy.ScenarioInfoUpdate -> RegisterEventHandler(SystemData.Events.SCENARIO_PLAYERS_LIST_STATS_UPDATED, Enemy.ScenarioInfoUpdate)
