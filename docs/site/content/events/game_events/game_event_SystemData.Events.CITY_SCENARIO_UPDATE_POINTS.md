...
- Enemy: Enemy._ScenarioInfoEnabledChanged -> SystemData.Events.CITY_SCENARIO_UPDATE_POINTS -> Enemy.ScenarioInfoUpdate
- Enemy: Enemy.ScenarioInfoUpdate -> RegisterEventHandler(SystemData.Events.CITY_SCENARIO_UPDATE_POINTS, Enemy.ScenarioInfoUpdate)
