...
- ZCurse_Profiler: CurseProfiler.Initialize -> SystemData.Events.QUIT -> CurseProfiler.repeatif
- ZCurse_Profiler: CurseProfiler.repeatif -> RegisterEventHandler(SystemData.Events.QUIT, CurseProfiler.repeatif)
