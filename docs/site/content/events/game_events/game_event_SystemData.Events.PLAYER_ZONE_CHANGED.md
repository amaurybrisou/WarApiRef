...
- ZCurse_Profiler: CurseProfiler.Initialize -> SystemData.Events.PLAYER_ZONE_CHANGED -> CurseProfiler.falsedo
- ZCurse_Profiler: CurseProfiler.falsedo -> RegisterEventHandler(SystemData.Events.PLAYER_ZONE_CHANGED, CurseProfiler.falsedo)
