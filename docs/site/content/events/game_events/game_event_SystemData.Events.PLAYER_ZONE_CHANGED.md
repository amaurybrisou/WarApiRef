...
| Evidence | Value |
| --- | --- |
| Addons seen in | CM_ClosetGoblin, Enemy, Killer, LibWBToggler, Shinies |
| Files seen in | `/workspace/data/raw/ClosetGoblin/ClosetGoblin.lua:1300`, `/workspace/data/raw/Enemy/Code/Core/Groups/Groups.lua:22`, `/workspace/data/raw/Enemy/Code/GroupIcons/GroupIcons.lua:62`, `/workspace/data/raw/Enemy/Code/TalismanAlerter/TalismanAlerter.lua:37`, `/workspace/data/raw/Killer/KillerLifecycle.lua:4`, `/workspace/data/raw/LibWarBoardToggler/LibWBTogglerManager.lua:12` |
| Namespaces detected | SystemData |
| Source kinds | event_page, flows, lua_event_registration |
| Example locations | CM_ClosetGoblin: ClosetGoblin.ZoneChangeInit, Enemy: Enemy.GroupsInitialize, Enemy: Enemy._GroupIconsEnabledChanged, Enemy: Enemy._TalismanAlerterEnabledChanged, Killer: Killer.Initialize, LibWBToggler: LibWBTogglerManager.Initialize |
| XML usage count | 0 |
...
- LibWBToggler: LibWBTogglerManager.Initialize -> SystemData.Events.PLAYER_ZONE_CHANGED -> LibWBTogglerManager.CheckMods
