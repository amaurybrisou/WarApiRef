...
- GCDsaver.PLAYER_TARGET_IS_IMMUNE_TO_DISABLES
- RegisterEventHandler
- global

## Examples

- GCDsaver: GCDsaver.RegisterEvents -> SystemData.Events.PLAYER_TARGET_IS_IMMUNE_TO_DISABLES -> GCDsaver.PLAYER_TARGET_IS_IMMUNE_TO_DISABLES
- GCDsaver: GCDsaver.PLAYER_TARGET_IS_IMMUNE_TO_DISABLES -> RegisterEventHandler(SystemData.Events.PLAYER_TARGET_IS_IMMUNE_TO_DISABLES, GCDsaver.PLAYER_TARGET_IS_IMMUNE_TO_DISABLES)
