...
- FastInteract.Interact
- RegisterEventHandler
- global

## Examples

- FastInteract: FastInteract.Initialize -> SystemData.Events.INTERACT_DEFAULT -> FastInteract.Interact
- FastInteract: FastInteract.Interact -> RegisterEventHandler(SystemData.Events.INTERACT_DEFAULT, FastInteract.Interact)
