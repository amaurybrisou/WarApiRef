...
- CurseProfiler.notnil
- RegisterEventHandler
- global

## Examples

- ZCurse_Profiler: CurseProfiler.Initialize -> SystemData.Events.INTERACT_DEFAULT -> CurseProfiler.notnil
- ZCurse_Profiler: CurseProfiler.notnil -> RegisterEventHandler(SystemData.Events.INTERACT_DEFAULT, CurseProfiler.notnil)
