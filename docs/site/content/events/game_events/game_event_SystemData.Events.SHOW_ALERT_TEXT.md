...
- Enemy.Groups_OnShowAlertText
- RegisterEventHandler
- global

## Examples

- Enemy: Enemy.GroupsInitialize -> SystemData.Events.SHOW_ALERT_TEXT -> Enemy.Groups_OnShowAlertText
- Enemy: Enemy.Groups_OnShowAlertText -> RegisterEventHandler(SystemData.Events.SHOW_ALERT_TEXT, Enemy.Groups_OnShowAlertText)
