...
- Enemy.ScenarioInfoCheckBroadcast
- RegisterEventHandler
- global

## Examples

- Enemy: Enemy._ScenarioInfoEnabledChanged -> SystemData.Events.SCENARIO_STOP_UPDATING_PLAYERS_STATS -> Enemy.ScenarioInfoCheckBroadcast
- Enemy: Enemy.ScenarioInfoCheckBroadcast -> RegisterEventHandler(SystemData.Events.SCENARIO_STOP_UPDATING_PLAYERS_STATS, Enemy.ScenarioInfoCheckBroadcast)
