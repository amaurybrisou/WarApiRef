...
- TidyQueue: TidyQueue.Initialize -> SystemData.Events.INTERACT_UPDATED_SCENARIO_QUEUE_LIST -> TidyQueue.ResetWindow
- TidyQueue: TidyQueue.ResetWindow -> RegisterEventHandler(SystemData.Events.INTERACT_UPDATED_SCENARIO_QUEUE_LIST, TidyQueue.ResetWindow)
