...
- PotionBar.OnPlayerBattleLevelUpdated
- RegisterEventHandler
- global

## Examples

- PotionBar: PotionBar.Initialize -> SystemData.Events.PLAYER_BATTLE_LEVEL_UPDATED -> PotionBar.OnPlayerBattleLevelUpdated
- PotionBar: PotionBar.OnPlayerBattleLevelUpdated -> RegisterEventHandler(SystemData.Events.PLAYER_BATTLE_LEVEL_UPDATED, PotionBar.OnPlayerBattleLevelUpdated)
