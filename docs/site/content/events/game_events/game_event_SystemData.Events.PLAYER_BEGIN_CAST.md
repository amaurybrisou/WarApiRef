...
- Squared: RegisterEventHandler -> SystemData.Events.PLAYER_BEGIN_CAST -> Squared.TargetUpdate
- Squared: Squared.TargetUpdate -> RegisterEventHandler(SystemData.Events.PLAYER_BEGIN_CAST, Squared.TargetUpdate)
