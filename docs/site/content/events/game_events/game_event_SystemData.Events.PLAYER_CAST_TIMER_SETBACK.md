...
- Effigy.Name..".SetbackCast"
- RegisterEventHandler
- global

## Examples

- Effigy: Effigy.RegisterStateInfoForCastbar -> SystemData.Events.PLAYER_CAST_TIMER_SETBACK -> Effigy.Name..".SetbackCast"
- Effigy: Effigy.Name..".SetbackCast" -> RegisterEventHandler(SystemData.Events.PLAYER_CAST_TIMER_SETBACK, Effigy.Name..".SetbackCast")
