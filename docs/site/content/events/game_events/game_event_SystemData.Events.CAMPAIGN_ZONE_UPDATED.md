...
- Killer.OnCampaignZoneUpdated
- RegisterEventHandler
- global

## Examples

- Killer: Killer.Initialize -> SystemData.Events.CAMPAIGN_ZONE_UPDATED -> Killer.OnCampaignZoneUpdated
- Killer: Killer.OnCampaignZoneUpdated -> RegisterEventHandler(SystemData.Events.CAMPAIGN_ZONE_UPDATED, Killer.OnCampaignZoneUpdated)
