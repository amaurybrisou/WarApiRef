...
- Effigy.Name..".UpdateCurrentAbilities"
- RegisterEventHandler
- global

## Examples

- Effigy: Effigy.RegisterStateInfoForCastbar -> SystemData.Events.PLAYER_ABILITIES_LIST_UPDATED -> Effigy.Name..".UpdateCurrentAbilities"
- Effigy: Effigy.Name..".UpdateCurrentAbilities" -> RegisterEventHandler(SystemData.Events.PLAYER_ABILITIES_LIST_UPDATED, Effigy.Name..".UpdateCurrentAbilities")
